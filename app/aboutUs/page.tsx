...
export default function AboutUsPage() {
    ...
    const StatCard = ({ stat }: { stat: Stat }) => (
        <div className="group bg-gradient-to-br from-purple-900/20 to-pink-900/20 p-8 rounded-3xl border border-purple-500/20 backdrop-blur-sm hover:border-purple-400/50 hover:bg-gradient-to-br hover:from-purple-900/30 hover:to-pink-900/30 transition-all duration-500 hover:scale-105">
    ...
    const ValueCard = ({ value }: { value: Value }) => (
        <div className="group text-center p-8 rounded-3xl bg-gradient-to-br from-gray-800/40 to-gray-900/40 border border-gray-600/30 hover:border-purple-400/50 transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl hover:shadow-purple-500/20">
    ...
    const TeamMemberCard = ({ member }: { member: TeamMember }) => (
        <div className="group relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 rounded-3xl border border-gray-600/30 hover:border-purple-400/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-purple-500/10 overflow-hidden">
            ...
            <div className="relative p-8">
                ...
                <div className="flex flex-col items-center text-center mb-6">
                    <div className="relative w-32 h-32 mb-6">
                        <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full p-1 group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="mb-4">
                        <div className="flex items-center justify-center gap-3 mb-3">
                            ...
                            <div className="text-center">
                                <h4 className="text-2xl font-bold group-hover:text-purple-300 transition-colors duration-300">
                                    {member.name}
                                </h4>
                            </div>
                        </div>

                        <p className="text-purple-400 font-semibold text-base leading-tight">
                            {member.role}
                        </p>
                    </div>
                </div>
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20">
            ...
            {/* Hero Section */}
            <section className="pt-10 pb-16 px-6 md:px-12 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
                {/* Background blur elements */}
                <div className="absolute -top-20 -left-20 w-80 h-80 bg-purple-500/20 rounded-full filter blur-3xl" />

                <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-pink-500/20 rounded-full filter blur-3xl" />

                <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-blue-500/10 rounded-full filter blur-3xl" />
                ...
                <div className="relative z-10 max-w-6xl mx-auto mt-20">
                    <div className="max-w-4xl">
                        ...
                        <div>
                            ...
                            <div className="w-32 h-1 bg-gradient-to-r from-purple-500 via-pink-500 to-purple-600 rounded-full mb-10" />

                            {/* Hero Cards */}
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 rounded-xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 hover:-translate-y-1">
                                ...
                                <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-6 rounded-xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-300 hover:-translate-y-1 md:col-span-2 lg:col-span-1">
                                    <div className="flex items-center mb-4">
                                        <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-4">
                                            <svg
                                                className="w-6 h-6 text-white"
            ...
            {/* Values Section */}
            <section className="py-32 px-6 md:px-12 bg-gradient-to-br from-gray-900/80 to-black relative">
            ...
            {/* Team Section */}
            <section id="team" className="py-32 px-6 md:px-12 bg-black relative">
                    ...
                    {teamCategories.map((category) => (
                        <div key={category} className="mb-20">
                            <div className="text-center mb-12">
                                ...
                                <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mx-auto mt-4" />
                            </div>
                            <div
            ...
            <footer className="py-12 px-6 md:px-12 bg-gray-900 border-t border-gray-800">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="pt-8 border-t border-gray-800 text-gray-500 flex flex-wrap justify-between">
                        ...
                        <p>Built with ❤️ by BitHive Technologies</p>
                    </div>
                </div>
            </footer>
        </div>
