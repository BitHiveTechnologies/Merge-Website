...
export default function AboutUsPage() {
    ...
    const StatCard = ({ stat }: { stat: Stat }) => (
        ...
        >
            ...
            <div className="text-gray-300 font-medium" data-oid=":uc5seg">
                {stat.label}
            </div>
        </div>
    );
    ...
    const TeamMemberCard = ({ member }: { member: TeamMember }) => (
        ...
        >
            ...
            <div className="relative p-8" data-oid="s-_cd:b">
                {/* Large Profile Image */}
                <div className="flex flex-col items-center text-center mb-6" data-oid="j_7j5hv">
                    <div className="relative w-32 h-32 mb-6" data-oid="7raqdht">
                        <div
                    ...
                    {/* Name and Role */}
                    <div className="mb-4" data-oid="gtrberv">
                        <div
                        ...
                        >
                            ...
                            <div className="text-center" data-oid="9ww_o.q">
                                <h4
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20 mt-10" data-oid="gx3pg7z">
                    ...
                    <div className="max-w-4xl" data-oid="2bcyi2q">
                        ...
                        <div data-oid=":ltkej1">
                            <h1
                                ...
                                data-oid="3hcgn5b"
                            >
                                <span className="text-white" data-oid="kz50vrs">
                                    About{' '}
                                </span>
                                <span
                            ...
                            >
                                ...
                                through
                                <span className="text-purple-400 font-semibold" data-oid="tpjxylk">
                                    {' '}
                            ...
                            >
                                <div
                                    ...
                                    data-oid="cdihd2b"
                                >
                                    <div className="flex items-center mb-4" data-oid="5--5qxr">
                                        <div
                                ...
                                <div
                                    ...
                                    data-oid="8wd_hcu"
                                >
                                    <div className="flex items-center mb-4" data-oid="_s80jhw">
                                        <div
                                            className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-4"
                                            data-oid="qe_yrqm"
                                        >
                                ...
                                <div
                                    ...
                                    data-oid="e357.ms"
                                >
                                    <div className="flex items-center mb-4" data-oid="l49n:xc">
                                        <div
                                            className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-4"
                                            data-oid="2jxmmoe"
                                        >
            ...
            >
                ...
                <div className="relative z-10 max-w-7xl mx-auto" data-oid="3o477ep">
                    <div className="text-center mb-20" data-oid="weo7r3p">
                        <h2 className="text-5xl md:text-5xl font-bold mb-8" data-oid="vyhwp.x">
                            What Drives{' '}
                            <span
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10" data-oid="7lrdx76">
                        {values.map((value, index) => (
                            <ValueCard key={index} value={value} data-oid="fptcil3" />
                        ))}
                    </div>
                </div>
            </section>
            ...
            {/* Team Section */}
            <section id="team" className="py-32 px-6 md:px-12 bg-black relative" data-oid="k-4l:ax">
                <div
                    className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-pink-500/5"
                    data-oid="3nwq5.a"
                />

                <div className="relative z-10 max-w-7xl mx-auto" data-oid="sd7jv6d">
                    <div className="text-center mb-20" data-oid="-w:b-ac">
                        <h2 className="text-5xl md:text-5xl font-bold mb-8" data-oid="mkvfzee">
                            The People Behind{' '}
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400"
                                data-oid="c21mj1_"
                    ...
                    {teamCategories.map((category) => (
                        <div key={category} className="mb-20" data-oid="fejjxa.">
                            <div className="text-center mb-12" data-oid="lovj5lu">
                                <h3 className="text-3xl font-bold" data-oid="ua625n:">
                                    <span
                                        className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400"
                                        data-oid="gvwfifb"
                                    >
            ...
            <footer
                ...
                data-oid="5t71690"
            >
                <div className="max-w-6xl mx-auto" data-oid="7s-3oy3">
                    <div className="grid md:grid-cols-4 gap-8 mb-12" data-oid="gazhnhr">
                        <div data-oid="yhi3m0_">
                            <Link href="/" data-oid="sp4kq-2">
                                <Image
                            ...
                            <p className="text-gray-400 mb-6 mt-4" data-oid="djukg.3">
                                Empowering Tech Enthusiasts to Learn, Build, and Grow Together.
                            </p>
                            <div className="flex space-x-2" data-oid="m2mquj8">
                                <a
                        ...
                        <div data-oid="qm1jyjz">
                            <h4 className="text-lg font-semibold mb-4" data-oid="hj8r.lf">
                                Quick Links
                            </h4>
                            <ul className="space-y-2" data-oid="15-14qs">
                                <li data-oid="uktucwm">
                                    <Link
                                        href="/"
                        ...
                        <div data-oid="driopw0">
                            <h4 className="text-lg font-semibold mb-4" data-oid="nh4h4lg">
                                Resources
                            </h4>
                            <ul className="space-y-2" data-oid="oq76z9r">
                                <li data-oid="8x1bamk">
                                    <a
                                        href="#"
                                        className="text-gray-400 hover:text-purple-400 transition-colors"
                        ...
                        <div data-oid="nbn-00w">
                            <h4 className="text-lg font-semibold mb-4" data-oid="uv7ie1p">
                                Contact Us
                            </h4>
                            <ul className="space-y-2" data-oid="z8w2rhq">
                                <li className="flex items-start" data-oid="o3aicwq">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="flex items-start" data-oid="c.4312p">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                    ...
                                    <span className="text-gray-400" data-oid="e02p-_g">
