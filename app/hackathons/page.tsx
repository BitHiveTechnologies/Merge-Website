...
export default function HackathonsPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="qo0t9co">
            {/* Navbar - reusing from main page */}
            <Navbar data-oid="fc8xzlu" />
            <SalesBanner data-oid=":k32c9-" />
            {/* Page Header */}
            <div
            ...
            >
                ...
                <div className="max-w-6xl mx-auto relative z-10 py-8" data-oid="6g3rnld">
                    <h1
                    ...
                    <div
                        ...
                        data-oid="o6q77.-"
                    ></div>
                    <div className="flex flex-wrap gap-4 mt-8" data-oid="ddzntrx">
                        <div
            ...
            <div
                ...
                data-oid="kp6ah:a"
            >
                <div className="max-w-6xl mx-auto" data-oid="ou5gz08">
                    <div className="flex space-x-4 border-b border-gray-800" data-oid="ye7qwf8">
                        <button
            ...
            {/* Hackathon Listings */}
            <div className="py-12 px-6 md:px-12 bg-black" data-oid="i80pa-5">
                <div className="max-w-6xl mx-auto" data-oid="7xn_96n">
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20" data-oid="6o9enow">
                            <div
                        ...
                        >
                            {hackathons.map((hackathon) => (
                                ...
                                >
                                    ...
                                    <div className="p-6" data-oid="26m2odx">
                                        <div
                                        ...
                                        <div
                                            ...
                                            data-oid="cjvpr74"
                                        >
                                            <div className="flex items-center" data-oid="t::0r6l">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <span data-oid="j2q_bsf">
                                                    {formatDate(hackathon.startDate)} -{' '}
                                                    {formatDate(hackathon.endDate)}
                                                </span>
                                            </div>
                                            <div className="flex items-center" data-oid="3zgmx2o">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-4 w-4 mr-1 text-purple-400"
                                                    viewBox="0 0 20 20"
                                                ...
                                                <span data-oid="00dra76">{hackathon.location}</span>
                                            </div>
                                        </div>
                                        <div
                        ...
                        <div className="space-y-12" data-oid="z-.d:fg">
                            <div className="mb-8" data-oid="b2efdzf">
                                <h2 className="text-3xl font-bold mb-6" data-oid="u9wr1y5">
                                    <span
                                        className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                        data-oid="3gltsf5"
                                    >
                                ...
                                <p className="text-gray-300 mb-8 max-w-4xl" data-oid="u1i.nqf">
                            ...
                            <div className="grid md:grid-cols-2 gap-8" data-oid="7s_qrsz">
                                {winners.map((winner) => (
                                    <div
                                        key={winner.id}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                data-oid="8bh2x-o"
                                            >
                                                <div className="p-6" data-oid="b7eu_fq">
                                                    <div
                                        ...
                                        <div className="p-6" data-oid="rwe1jo8">
                                            <div className="mb-4" data-oid="5tj:te6">
                                                <div
                                                ...
                                                <div className="font-medium" data-oid="rfvr-r0">
                                                    {winner.teamName}
                                                </div>
                                            </div>
                                            <p
                                            ...
                                            <div className="mb-4" data-oid="vhr2n3a">
                                                <div
                                                    className="text-gray-400 text-sm mb-2"
                                                    data-oid="x4jotnf"
                                                >
            ...
            <footer
                ...
                data-oid="jbc-y3e"
            >
                <div className="max-w-6xl mx-auto" data-oid="jb13wip">
                    <div className="text-center text-gray-500" data-oid="h3_co75">
                        <p data-oid="jkrh2z1">
