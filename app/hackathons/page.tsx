...
export default function HackathonsPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="7:8tguu">
            {/* Navbar - reusing from main page */}
            <Navbar data-oid="sz4iu7p" />
            <SalesBanner data-oid="f58_eyu" />
            {/* Page Header */}
            <div
            ...
            >
                ...
                <div className="max-w-6xl mx-auto relative z-10 py-8" data-oid="4r5kcje">
                    <h1
                    ...
                    <div
                        ...
                        data-oid="ztry75v"
                    ></div>
                    <div className="flex flex-wrap gap-4 mt-8" data-oid="ol7hclc">
                        <div
            ...
            <div
                ...
                data-oid="y1zulja"
            >
                <div className="max-w-6xl mx-auto" data-oid="o_yasd:">
                    <div className="flex space-x-4 border-b border-gray-800" data-oid="21_0sya">
                        <button
            ...
            {/* Hackathon Listings */}
            <div className="py-12 px-6 md:px-12 bg-black" data-oid="yn52r6m">
                <div className="max-w-6xl mx-auto" data-oid="ufua-yr">
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20" data-oid="fj1ic-t">
                            <div
                        ...
                        >
                            {hackathons.map((hackathon) => (
                                ...
                                >
                                    ...
                                    <div className="p-6" data-oid="dflgomo">
                                        <div
                                        ...
                                        <div
                                            ...
                                            data-oid="x:tld9b"
                                        >
                                            <div className="flex items-center" data-oid="-crpr93">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <span data-oid="lstj6ho">
                                                    {formatDate(hackathon.startDate)} -{' '}
                                                    {formatDate(hackathon.endDate)}
                                                </span>
                                            </div>
                                            <div className="flex items-center" data-oid="57k.g8l">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-4 w-4 mr-1 text-purple-400"
                                                    viewBox="0 0 20 20"
                                                ...
                                                <span data-oid="rfgbm7w">{hackathon.location}</span>
                                            </div>
                                        </div>
                                        <div
                        ...
                        <div className="space-y-12" data-oid="kwnq2k:">
                            <div className="mb-8" data-oid="1tx4xdr">
                                <h2 className="text-3xl font-bold mb-6" data-oid="vy3jsq-">
                                    <span
                                        className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                        data-oid="ph:os:j"
                                    >
                                ...
                                <p className="text-gray-300 mb-8 max-w-4xl" data-oid="9668:tj">
                            ...
                            <div className="grid md:grid-cols-2 gap-8" data-oid="is98cl8">
                                {winners.map((winner) => (
                                    <div
                                        key={winner.id}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                data-oid="d8crl2c"
                                            >
                                                <div className="p-6" data-oid="b.30m25">
                                                    <div
                                        ...
                                        <div className="p-6" data-oid="rqig5nz">
                                            <div className="mb-4" data-oid="g3306ym">
                                                <div
                                                ...
                                                <div className="font-medium" data-oid="j9331bt">
                                                    {winner.teamName}
                                                </div>
                                            </div>
                                            <p
                                            ...
                                            <div className="mb-4" data-oid="zkt_m:n">
                                                <div
                                                    className="text-gray-400 text-sm mb-2"
                                                    data-oid="-ljzcps"
                                                >
            ...
            <footer
                ...
                data-oid=":sdt1kd"
            >
                <div className="max-w-6xl mx-auto" data-oid="o:.or_v">
                    <div className="text-center text-gray-500" data-oid="y_iq3uy">
                        <p data-oid="idlf0oy">
