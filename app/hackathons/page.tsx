...
export default function HackathonsPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="sjv7nq5">
            {/* Navbar - reusing from main page */}
            <Navbar data-oid="p6:p0f7" />
            <SalesBanner data-oid="bp5v4-e" />
            {/* Page Header */}
            <div
            ...
            >
                ...
                <div className="max-w-6xl mx-auto relative z-10 py-8" data-oid="i19snoo">
                    <h1
                    ...
                    <div
                        ...
                        data-oid=".v79gxi"
                    ></div>
                    <div className="flex flex-wrap gap-4 mt-8" data-oid=".xa2eyc">
                        <div
            ...
            <div
                ...
                data-oid="2l:vv0_"
            >
                <div className="max-w-6xl mx-auto" data-oid="iw5._r0">
                    <div className="flex space-x-4 border-b border-gray-800" data-oid="watz01b">
                        <button
            ...
            {/* Hackathon Listings */}
            <div className="py-12 px-6 md:px-12 bg-black" data-oid="mp:r_52">
                <div className="max-w-6xl mx-auto" data-oid="phjcykf">
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20" data-oid="wi.1z9n">
                            <div
                        ...
                        >
                            {hackathons.map((hackathon) => (
                                ...
                                >
                                    ...
                                    <div className="p-6" data-oid="dhurctx">
                                        <div
                                        ...
                                        <div
                                            ...
                                            data-oid="-a:79::"
                                        >
                                            <div className="flex items-center" data-oid="rr-ywr.">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <span data-oid="vgdma86">
                                                    {formatDate(hackathon.startDate)} -{' '}
                                                    {formatDate(hackathon.endDate)}
                                                </span>
                                            </div>
                                            <div className="flex items-center" data-oid=":7bv_76">
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="h-4 w-4 mr-1 text-purple-400"
                                                    viewBox="0 0 20 20"
                                                ...
                                                <span data-oid="6cw8.xs">{hackathon.location}</span>
                                            </div>
                                        </div>
                                        <div
                        ...
                        <div className="space-y-12" data-oid="s3elik1">
                            <div className="mb-8" data-oid="nujvpvn">
                                <h2 className="text-3xl font-bold mb-6" data-oid=".mmbm_x">
                                    <span
                                        className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                        data-oid="p2rvlin"
                                    >
                                ...
                                <p className="text-gray-300 mb-8 max-w-4xl" data-oid="vcjo967">
                            ...
                            <div className="grid md:grid-cols-2 gap-8" data-oid="_b8p3.-">
                                {winners.map((winner) => (
                                    <div
                                        key={winner.id}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                ...
                                                data-oid="x0p5fq8"
                                            >
                                                <div className="p-6" data-oid="uexpx72">
                                                    <div
                                        ...
                                        <div className="p-6" data-oid="f34xq_f">
                                            <div className="mb-4" data-oid="y28bgy4">
                                                <div
                                                ...
                                                <div className="font-medium" data-oid="pabvo0a">
                                                    {winner.teamName}
                                                </div>
                                            </div>
                                            <p
                                            ...
                                            <div className="mb-4" data-oid="mvc1fzl">
                                                <div
                                                    className="text-gray-400 text-sm mb-2"
                                                    data-oid="r1dgnlv"
                                                >
            ...
            <footer
                ...
                data-oid="rekkrnw"
            >
                <div className="max-w-6xl mx-auto" data-oid="k:5jgvg">
                    <div className="text-center text-gray-500" data-oid="uo1pqy7">
                        <p data-oid="-57ezqx">
