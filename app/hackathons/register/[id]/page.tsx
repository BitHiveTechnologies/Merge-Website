...
export default function HackathonRegistrationPage({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="a3n5i:6">
            {/* Navbar - reusing from main page */}
            <Navbar data-oid="r_5ragd" />

            {/* Registration Content */}
            <div className="py-12 px-6 md:px-12 bg-black" data-oid="sn:qpad">
                <div className="max-w-4xl mx-auto" data-oid="tmexfrb">
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20" data-oid="fm73s93">
                            <div
                        ...
                        <>
                            ...
                            {isSubmitted ? (
                                ...
                                >
                                    ...
                                    <h2 className="text-2xl font-bold mb-4" data-oid="t8155cr">
                                        Registration Successful!
                                    </h2>
                                    <p className="text-gray-300 mb-6" data-oid="h.e6i:d">
                                    ...
                                    <div
                                        ...
                                        data-oid="n2o3yh1"
                                    >
                                        <div className="text-left mb-4" data-oid=".qjj0pm">
                                            <div
                                            ...
                                            <div className="font-medium" data-oid="bzp0moh">
                                                HACKBIT2025-
                                        ...
                                        <div className="text-left mb-4" data-oid="u8cwy6w">
                                            <div
                                                className="text-gray-400 text-sm"
                                                data-oid="r8z07zx"
                                            >
                                            ...
                                            <div className="font-medium" data-oid="tqnkhiw">
                                                {formData.teamName}
                                            </div>
                                        </div>
                                        <div className="text-left" data-oid="tpdoghj">
                                            <div
                                                className="text-gray-400 text-sm"
                                                data-oid="f.zs7i3"
                                            >
                                            ...
                                            <div className="font-medium" data-oid="ucsm-up">
                                                {formData.track}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <>
                                    <div className="text-center mb-12" data-oid="lie5dre">
                                        <h1
                                    ...
                                    >
                                        <div
                                            ...
                                            data-oid="drh21k_"
                                        >
                                            <div className="w-full md:w-1/4" data-oid="_4ul3:2">
                                                <img
                                                    src={hackathon.image}
                                                    alt={hackathon.title}
                                            ...
                                            <div className="w-full md:w-3/4" data-oid="_fggo:b">
                                                <h2
                                    ...
                                    >
                                            ...
                                            >
                                                ...
                                                <div data-oid="22a_d7b">
                                                    ...
                                                    <select
                                                        ...
                                                        data-oid="0n-7i3h"
                                                    >
                                                        <option value="1" data-oid="vqg00s.">
                                                            1 (Individual)
                                                        </option>
                                                        <option value="2" data-oid="wxkq_49">
                                                            2 Members
                                                        </option>
                                                        <option value="3" data-oid="nkg_fv0">
                                                            3 Members
                                                        </option>
                                                        <option value="4" data-oid=":owu7uh">
                                                            4 Members
                                                        </option>
                                                        <option value="5" data-oid="chl1k07">
                                                            5 Members
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            >
                                                ...
                                                <div data-oid="-.__sr6">
                                                    ...
                                                    <select
                                                        ...
                                                        data-oid="rpb-fjg"
                                                    >
                                                        <option value="" data-oid="oyh.pex">
                                                            Select your experience level
                                                        </option>
                                                        <option value="Beginner" data-oid="9o--m5z">
                                                            Beginner (0-1 years)
                                                        </option>
                                                        <option
                                                            value="Intermediate"
                                                        ...
                                                        <option value="Advanced" data-oid="lvbh6o-">
                                                            Advanced (3+ years)
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div className="mt-6" data-oid="e3kqesj">
                                                <label
                                        ...
                                        <div
                                            ...
                                            data-oid="hp4e7f8"
                                        >
                                            <div className="flex items-start" data-oid="xpcy5rs">
                                                <div
                                        ...
                                        {/* Submit Button */}
                                        <div className="flex justify-center" data-oid="vr3w7n-">
                                            <button
                                                type="submit"
                        ...
                        <div className="text-center py-20" data-oid="-:zhl3y">
                            <h3
                            ...
                            <p className="text-gray-400 mb-8" data-oid="a802aaj">
            ...
            <footer
                ...
                data-oid="okrk46b"
            >
                <div className="max-w-6xl mx-auto" data-oid="ur_8daq">
                    <div className="text-center text-gray-500" data-oid="to1-0g.">
                        <p data-oid="88006b-">
