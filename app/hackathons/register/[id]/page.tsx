...
export default function HackathonRegistrationPage({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="u.2epln">
            {/* Navbar - reusing from main page */}
            <Navbar data-oid="23ybw-d" />

            {/* Registration Content */}
            <div className="py-12 px-6 md:px-12 bg-black" data-oid="1t2mhyc">
                <div className="max-w-4xl mx-auto" data-oid="ky14x_9">
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20" data-oid="4zh7.2d">
                            <div
                        ...
                        <>
                            ...
                            {isSubmitted ? (
                                ...
                                >
                                    ...
                                    <h2 className="text-2xl font-bold mb-4" data-oid="dlul33-">
                                        Registration Successful!
                                    </h2>
                                    <p className="text-gray-300 mb-6" data-oid="vh8go.o">
                                    ...
                                    <div
                                        ...
                                        data-oid=".j227:5"
                                    >
                                        <div className="text-left mb-4" data-oid="dhyhtge">
                                            <div
                                            ...
                                            <div className="font-medium" data-oid="-5la3ew">
                                                HACKBIT2025-
                                        ...
                                        <div className="text-left mb-4" data-oid="oc.fs2a">
                                            <div
                                                className="text-gray-400 text-sm"
                                                data-oid="w3-yrxh"
                                            >
                                            ...
                                            <div className="font-medium" data-oid="7:iu:v4">
                                                {formData.teamName}
                                            </div>
                                        </div>
                                        <div className="text-left" data-oid="06oonnk">
                                            <div
                                                className="text-gray-400 text-sm"
                                                data-oid="b5lailn"
                                            >
                                            ...
                                            <div className="font-medium" data-oid="nq2:ltf">
                                                {formData.track}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <>
                                    <div className="text-center mb-12" data-oid="vlilh50">
                                        <h1
                                    ...
                                    >
                                        <div
                                            ...
                                            data-oid="gqffeat"
                                        >
                                            <div className="w-full md:w-1/4" data-oid="k2zu_16">
                                                <img
                                                    src={hackathon.image}
                                                    alt={hackathon.title}
                                            ...
                                            <div className="w-full md:w-3/4" data-oid="j-4kp_m">
                                                <h2
                                    ...
                                    >
                                            ...
                                            >
                                                ...
                                                <div data-oid="i_ma.-q">
                                                    ...
                                                    <select
                                                        ...
                                                        data-oid="mifqap1"
                                                    >
                                                        <option value="1" data-oid="z6fnxpp">
                                                            1 (Individual)
                                                        </option>
                                                        <option value="2" data-oid="ucdwp-:">
                                                            2 Members
                                                        </option>
                                                        <option value="3" data-oid="fqzg4.m">
                                                            3 Members
                                                        </option>
                                                        <option value="4" data-oid="-2g:lc.">
                                                            4 Members
                                                        </option>
                                                        <option value="5" data-oid="57qql_p">
                                                            5 Members
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            >
                                                ...
                                                <div data-oid="j78gf0n">
                                                    ...
                                                    <select
                                                        ...
                                                        data-oid="9fqy0ci"
                                                    >
                                                        <option value="" data-oid="takt2:d">
                                                            Select your experience level
                                                        </option>
                                                        <option value="Beginner" data-oid=".i8r3:k">
                                                            Beginner (0-1 years)
                                                        </option>
                                                        <option
                                                            value="Intermediate"
                                                        ...
                                                        <option value="Advanced" data-oid="ce3qi-x">
                                                            Advanced (3+ years)
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div className="mt-6" data-oid="j1r9h57">
                                                <label
                                        ...
                                        <div
                                            ...
                                            data-oid=".jc1oq5"
                                        >
                                            <div className="flex items-start" data-oid="1o8tqu-">
                                                <div
                                        ...
                                        {/* Submit Button */}
                                        <div className="flex justify-center" data-oid="ypu.l5r">
                                            <button
                                                type="submit"
                        ...
                        <div className="text-center py-20" data-oid="i2xb5wo">
                            <h3
                            ...
                            <p className="text-gray-400 mb-8" data-oid="2.zh89c">
            ...
            <footer
                ...
                data-oid="jr61gi6"
            >
                <div className="max-w-6xl mx-auto" data-oid="tz_7xk8">
                    <div className="text-center text-gray-500" data-oid="7yvc18j">
                        <p data-oid="96n2e19">
