...
export default function HackathonDetailPage({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid=".1a4-r7">
            {/* Navbar - reusing from main page */}
            <Navbar data-oid="9lz2o_3" />
            {/* Hackathon Detail Content */}
            <div className="py-12 px-6 md:px-12 bg-black" data-oid="h4u_vns">
                <div className="max-w-6xl mx-auto" data-oid="ck_xn3m">
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20" data-oid="r_t1sj1">
                            <div
                        ...
                        <div data-oid="2m2tczv">
                            ...
                            <div
                                ...
                                data-oid="3p:6ke1"
                            >
                                <div className="absolute inset-0" data-oid="hhziqw6">
                                    <img
                                        src={hackathon.image}
                                        alt={hackathon.title}
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <span data-oid="1c5_9wr">{hackathon.location}</span>
                                            </div>
                                            <div
                                                className="bg-gray-800/50 backdrop-blur-sm px-6 py-4 rounded-lg border border-gray-700 inline-flex items-center"
                                                data-oid="72-1t9t"
                                        ...
                                        {hackathon.isUpcoming && timeRemaining && (
                                            <div className="mb-8" data-oid="7ozy068">
                                                <h3
                            ...
                            {/* Navigation tabs */}
                            <div className="border-b border-gray-800 mb-12" data-oid="sdwu2.g">
                                <div
                            ...
                            {/* Content sections */}
                            <div className="mb-16" data-oid="iyng0ll">
                                {/* Overview section */}
                                {activeSection === 'overview' && (
                                    <div data-oid="gxaf132">
                                        <h2 className="text-3xl font-bold mb-6" data-oid="ti79-6c">
                                            <span
                                        ...
                                        {hackathon.judges && hackathon.judges.length > 0 && (
                                            <div className="mt-12" data-oid="fxrrvcu">
                                                <h3
                                        ...
                                        {hackathon.sponsors && hackathon.sponsors.length > 0 && (
                                            <div className="mt-12" data-oid="t.f78f8">
                                                <h3
                                                    className="text-2xl font-bold mb-6"
                                                    data-oid="mhoa.xc"
                                                >
                                ...
                                {/* Tracks section */}
                                {activeSection === 'tracks' && (
                                    <div data-oid="qkxp0jz">
                                        <h2 className="text-3xl font-bold mb-6" data-oid="c6dt8hs">
                                            <span
                                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                                data-oid="a_f0lk."
                                            >
                                ...
                                {/* Structure section */}
                                {activeSection === 'structure' && (
                                    <div data-oid="fgna_2z">
                                        <h2 className="text-3xl font-bold mb-6" data-oid="8g1ati7">
                                            <span
                                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                                data-oid="1v9la.8"
                                            >
                                        ...
                                        <div className="space-y-6" data-oid="tt8lh7.">
                                        ...
                                        <div className="mt-12" data-oid=":jwle39">
                                            <h3
                                ...
                                {activeSection === 'prerequisites' && (
                                    <div data-oid="ze5nl1y">
                                        <h2 className="text-3xl font-bold mb-6" data-oid="u99.htd">
                                            <span
                                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                                data-oid="cdfhjme"
                                            >
                                ...
                                {activeSection === 'faqs' && hackathon.faqs && (
                                    <div data-oid="9aydcx3">
                                        <h2 className="text-3xl font-bold mb-6" data-oid="kimsqkl">
                                            <span
                                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                                data-oid="nh4ca:y"
                                            >
                                        ...
                                        <div className="space-y-6" data-oid="zt-pizl">
                                            {hackathon.faqs.map((faq, index) => (
                                                ...
                                                >
                                                    ...
                                                    <p className="text-gray-300" data-oid="7wf6ppn">
                                                        {faq.answer}
                                                    </p>
                                                </div>
                                            ))}
                        ...
                        <div className="text-center py-20" data-oid="oat0his">
                            <h3
                            ...
                            <p className="text-gray-400 mb-8" data-oid="yde3p_n">
            ...
            <footer
                ...
                data-oid="-m2x.pk"
            >
                <div className="max-w-6xl mx-auto" data-oid="amgrkc4">
                    <div className="text-center text-gray-500" data-oid="4fizu_b">
                        <p data-oid="oc6c1ty">
