...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="qk-ocsq">
            <Navbar data-oid="1_8lce-" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="k8m3.yu">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden"
                    data-oid="x1038p0"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="p13:gid">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="e5r5dpj">
                        <div className="text-center mb-6" data-oid="3kjmf.p">
                            <h1 className="text-3xl font-bold mb-2" data-oid=".lg8rgj">
                                Create an Account
                            </h1>
                            <p className="text-gray-400" data-oid="6t5vg:g">
                        ...
                        <form onSubmit={handleSubmit} data-oid=".__dl-e">
                            <div className="mb-6" data-oid="m3ymzzk">
                                <label
                                    htmlFor="name"
                            ...
                            <div className="mb-6" data-oid="s-d12aw">
                                <label
                                    htmlFor="email"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="bkuwxl:"
                            ...
                            <div className="mb-6" data-oid="kj_wo61">
                                <label
                                    htmlFor="password"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="zfgxaal"
                                ...
                                <div className="relative" data-oid="5q1ouaw">
                                    <input
                                        id="password"
                                        name="password"
                                ...
                                <p className="mt-1 text-xs text-gray-400" data-oid="grjfdbq">
                                    Password must be at least 8 characters long
                                </p>
                            </div>

                            <div className="flex items-start mb-6" data-oid="foti8-k">
                                <div className="flex items-center h-5" data-oid="30e7_sh">
                                    <input
                                        id="agreeToTerms"
                                        name="agreeToTerms"
                                        type="checkbox"
                                ...
                                <div className="ml-3 text-sm" data-oid="5zz4ypg">
                                    <label
                        ...
                        <div className="mt-6 text-center" data-oid="qdwnl02">
                            <p className="text-gray-400" data-oid="0z3k0sl">
