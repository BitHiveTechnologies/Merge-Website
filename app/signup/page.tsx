...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid=".ik27k0">
            <Navbar data-oid="l3s6qcs" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="eqqmthi">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden"
                    data-oid="dmegn-0"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="piz.ypw">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="o7_qmm1">
                        <div className="text-center mb-6" data-oid="5mnwxx_">
                            <h1 className="text-3xl font-bold mb-2" data-oid="os-al.p">
                                Create an Account
                            </h1>
                            <p className="text-gray-400" data-oid="yuv.3.z">
                        ...
                        <form onSubmit={handleSubmit} data-oid="_wve60o">
                            <div className="mb-6" data-oid="wkxf:o_">
                                <label
                                    htmlFor="name"
                            ...
                            <div className="mb-6" data-oid="sj9jdxi">
                                <label
                                    htmlFor="email"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="t:5dxq_"
                            ...
                            <div className="mb-6" data-oid="jn.12wb">
                                <label
                                    htmlFor="password"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="fv1s-2u"
                                ...
                                <div className="relative" data-oid="6joghvm">
                                    <input
                                        id="password"
                                        name="password"
                                ...
                                <p className="mt-1 text-xs text-gray-400" data-oid="l3m86rd">
                                    Password must be at least 8 characters long
                                </p>
                            </div>

                            <div className="flex items-start mb-6" data-oid="upup-:u">
                                <div className="flex items-center h-5" data-oid="ew-y-74">
                                    <input
                                        id="agreeToTerms"
                                        name="agreeToTerms"
                                        type="checkbox"
                                ...
                                <div className="ml-3 text-sm" data-oid="8e78t8g">
                                    <label
                        ...
                        <div className="mt-6 text-center" data-oid="0bod8:h">
                            <p className="text-gray-400" data-oid="6q6p8w6">
