...
export default function SignupPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="n3m:svx">
            <Navbar data-oid="ypecbek" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="9oi_z1l">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden"
                    data-oid="rowgqiw"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="5yb2:o2">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="pzkr-na">
                        <div className="text-center mb-6" data-oid="cuipnyt">
                            <h1 className="text-3xl font-bold mb-2" data-oid="y:qwoa8">
                                Create an Account
                            </h1>
                            <p className="text-gray-400" data-oid="75nawz2">
                        ...
                        <form onSubmit={handleSubmit} data-oid="efi8n.q">
                            <div className="mb-6" data-oid="zoxdz5.">
                                <label
                                    htmlFor="name"
                            ...
                            <div className="mb-6" data-oid="0t8idip">
                                <label
                                    htmlFor="email"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="tr90w_5"
                            ...
                            <div className="mb-6" data-oid="99hfgrh">
                                <label
                                    htmlFor="password"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="_uxcv6i"
                                ...
                                <div className="relative" data-oid="z3dmsl9">
                                    <input
                                        id="password"
                                        name="password"
                                ...
                                <p className="mt-1 text-xs text-gray-400" data-oid=":1k14aa">
                            ...
                            <div className="flex items-start mb-6" data-oid="mpccm23">
                                <div className="flex items-center h-5" data-oid="9q12bkb">
                                    <input
                                        id="agreeToTerms"
                                        name="agreeToTerms"
                                        type="checkbox"
                                ...
                                <div className="ml-3 text-sm" data-oid="._pg7:s">
                                    <label
                        ...
                        <div className="mt-6 text-center" data-oid="8b5nxmz">
                            <p className="text-gray-400" data-oid="j2f.pqq">
