...
export default function WorkshopsPage() {
    ...
    useEffect(() => {
        const fetchWorkshops = async () => {
            ...
            try {
                ...
                const upcomingResponse = await fetch(`${BACKEND_URL}/api/workshops/upcoming`);
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="d2rls15">
            {/* Navbar - reusing from main page */}
            <Navbar data-oid="272:2t1" />
            {/* Page Header */}
            <div
            ...
            >
                ...
                <div className="max-w-6xl mx-auto relative z-10 py-8" data-oid="koeufqx">
                    <h1
                    ...
                    <div
                        ...
                        data-oid="3ed.im3"
                    ></div>
                    <div className="flex flex-wrap gap-4 mt-8" data-oid="ruy-g.q">
                        <div
            ...
            <div
                ...
                data-oid="ca2xidv"
            >
                <div className="max-w-6xl mx-auto" data-oid="wzjoy2c">
                    <div className="flex space-x-4 border-b border-gray-800" data-oid="6nw0ief">
                        <button
            ...
            {/* Workshop Listings */}
            <div className="py-12 px-6 md:px-12 bg-black" data-oid="cup0j5j">
                <div className="max-w-6xl mx-auto" data-oid="4w:ac4:">
                    {isLoading ? (
                        <div className="flex justify-center items-center py-20" data-oid="z.1iwjo">
                            <div
                        ...
                        >
                            {upcomingWorkshops.map((workshop) => (
                                ...
                                >
                                    ...
                                    <div className="p-6" data-oid="jpt_0i1">
                                        <h3
                                        ...
                                        <div className="flex items-center mb-3" data-oid="zj4s.pu">
                                            <div
                                        ...
                                        <div
                                            ...
                                            data-oid="ip3ymm2"
                                        >
                                            <span data-oid="xw6yk5e">{workshop.time}</span>
                                            <span data-oid="mxmx30t">{workshop.location}</span>
                                        </div>
                                        <div
                        ...
                        <div className="space-y-12" data-oid="gknbx-l">
                            <div className="mb-8" data-oid="n_ye58z">
                                <h2 className="text-3xl font-bold mb-6" data-oid="-optj9q">
                                    <span
                                        className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                        data-oid="yhot555"
                                    >
                                ...
                                <p className="text-gray-300 mb-8 max-w-4xl" data-oid="ne:5tl:">
                            ...
                            <div className="grid gap-8" data-oid="cvb3zr2">
                                {pastWorkshops.map((workshop) => (
                                    ...
                                    >
                                        <div
                                            ...
                                            data-oid="dms:r5h"
                                        >
                                            <div className="md:w-1/4" data-oid="gqoi7yi">
                                                <h3
                                            ...
                                            <div className="md:w-3/4" data-oid="4pf1n-h">
                                                <div className="mb-4" data-oid="l420pls">
                                                    <h4
            ...
            <footer
                ...
                data-oid="0_thadq"
            >
                <div className="max-w-6xl mx-auto" data-oid="2zgm9m7">
                    <div className="text-center text-gray-500" data-oid="2jmjbwz">
                        <p data-oid="0..cg5e">
