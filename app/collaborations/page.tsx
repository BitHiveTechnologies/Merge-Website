            ...
            <section className="pt-10 pb-16 px-6 md:px-12 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto mt-20">
                    <div className="text-center">
                        ...
                        <div className="w-32 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mx-auto mb-10" />
                    </div>
                </div>
            </section>
                            ...
                            {duplicatedPartners.map((partner, index) => (
                                ...
                                >
                                    <div className="flex flex-col items-center">
                                        ...
                                        <h3 className="text-center font-semibold text-gray-300 group-hover:text-white transition-colors">
                                            {partner.name}
                                        </h3>
                                    </div>
                                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            >
                                <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 text-white">
                                    {item.icon}
                                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            >
                                <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300 text-white">
                                    {tool.icon}
                                </div>
            ...
            <section className="py-20 px-6 md:px-12 bg-gray-900">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
                            ...
                            <tbody className="divide-y divide-gray-700">
                                {[
                                    ...
                                    >
                                        <td className="px-6 py-4 font-medium">{row.criteria}</td>
                                        <td className={`px-6 py-4 text-center ${row.merge.color}`}>
                                            {row.merge.text}
                                        </td>
                                        <td className={`px-6 py-4 text-center ${row.others.color}`}>
                                            {row.others.text}
                                        </td>
                                    </tr>
                                ))}
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8">
                            {[
                                ...
                                <div key={index} className="flex items-start space-x-4">
                                    <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center flex-shrink-0 text-white">
                                        {item.icon}
                                    </div>
                                    <div>
                        ...
                        <div className="relative">
                            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 p-8 rounded-2xl border border-purple-500/30">
                                <div className="text-center">
