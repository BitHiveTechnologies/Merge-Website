                        ...
                        >
                            {duplicatedPartners.map((partner, index) => (
                                <div
                                    ...
                                    className="flex-shrink-0 w-64 bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-gray-700 hover:border-purple-500 transition-all duration-300 hover:-translate-y-2 group"
                                    data-oid="dnjknuk"
                                >
                                    <div className="flex flex-col items-center" data-oid="zbp_gki">
                                        <div className="w-20 h-20 mb-4 relative" data-oid="7kb8enk">
                                            <Image
                                                src={partner.logo}
                                                alt={partner.name}
                                                fill
