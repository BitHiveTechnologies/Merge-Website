                    ...
                    <div className="relative overflow-hidden">
                        ...
                        >
                            ...
                            {testimonials.map((testimonial, index) => (
                                <div key={`first-${index}`} className="flex-shrink-0 px-3 w-80">
                                    <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 hover:border-purple-500/50 transition-all duration-300 h-64">
                                        ...
                                        <div className="relative">
                                            ...
                                            <p className="text-sm text-gray-300 italic leading-relaxed pl-3 ">
                                                "{testimonial.content}"
                                            </p>
                                        </div>
                                    </div>
                            ...
                            {testimonials.map((testimonial, index) => (
                                <div key={`second-${index}`} className="flex-shrink-0 px-3 w-80">
                                    <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 hover:border-purple-500/50 transition-all duration-300 h-64">
                                        <div className="flex items-center mb-4">
                                            <div className="relative">
                                                <img
