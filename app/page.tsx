...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid=".sivd_:">
            {/* Navbar */}
            <Navbar data-oid="_o27.vd" />
            <SalesBanner data-oid="y7_6_f0" />
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden bg-gray-900 p-4" data-oid=":9ka:ua">
                    <div className="flex flex-col space-y-3" data-oid="cuqhhd.">
                        <a
                            href="/"
                        ...
                        <div className="pt-4 flex space-x-4" data-oid="yqssi4p">
                            <a
                                href="/login"
            ...
            >
                ...
                <div className="relative z-10" data-oid="gi4n6y5">
                    <div
                        className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center"
                        data-oid="ar.88g0"
                    >
                        <div className="py-8" data-oid="u8jxe88">
                            <h1
                            ...
                            >
                                <span
                                    ...
                                    data-oid="az3iey8"
                                >
                                    Merge <br data-oid="m:itki:" /> Your Skills
                                </span>
                                <br data-oid="b8:n7m7" />
                                <span data-oid="d:.huuw">With Opportunity</span>
                            </h1>
                            <p
                            ...
                            <div
                                ...
                                data-oid="sbe0p38"
                            ></div>
                            <div className="flex flex-col sm:flex-row gap-4" data-oid="fm7:dp2">
                                <a
                                    href="/courses"
                        ...
                        <div className="hidden md:block relative" data-oid="ml1f27a">
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="kb:zgyi">
                                        <h3
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="xs2rp:-">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="gmkl2sm"
                                        >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="obs5048">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="6ray:06"
                                        >
            ...
            {/* Features Section */}
            <section className="py-8 md:py-16 px-6 md:px-12 bg-gray-900" data-oid="dcac38-">
                <div className="max-w-6xl mx-auto" data-oid="ebwpdzj">
                    <div className="text-center mb-16" data-oid="8bindg-">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="cwo4o_d">
                            Why Choose{' '}
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                data-oid="6vtpshx"
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid=".90vb8j">
                            We combine learning, practice, and networking to give you the complete
                            package for tech career growth.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8" data-oid="l0fax_8">
                        <div
            ...
            <FeaturedCourses data-oid="_tj4.5m" />
            ...
            <section
                ...
                data-oid="b._tpg1"
            >
                <div className="max-w-6xl mx-auto" data-oid="tznu2qy">
                    <div className="text-center mb-16" data-oid="-q2_t12">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="ctiay09">
                            What Our Students Say
                        </h2>
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="ht2cwla">
                            Join thousands of satisfied learners who have transformed their careers
                            with Merge.
                        </p>
                    </div>

                    <div className="relative" data-oid="qlpf0q4">
                        <div className="overflow-hidden" data-oid="w9v887-">
                            <div
                            ...
                            >
                                {testimonials.map((testimonial, index) => (
                                    <div key={index} className="min-w-full px-4" data-oid="jkfh0q8">
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="ml-4" data-oid="wb8yb.0">
                                                    <h3
                                                    ...
                                                    <p className="text-gray-400" data-oid="-ixb.:5">
                                                        {testimonial.role}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="flex justify-center mt-8 space-x-2" data-oid="q-1nsms">
            ...
            <section className="py-20 px-6 md:px-12 bg-gray-900" data-oid="h7bpcws">
                <div className="max-w-6xl mx-auto" data-oid="4cr8cfc">
                    <div className="flex justify-between items-end mb-12" data-oid="u_0:6.a">
                        <div data-oid="idt0jao">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="zt61rxi">
                                Upcoming Workshops
                            </h2>
                            <p className="text-xl text-gray-300" data-oid="2yj7.c7">
                    ...
                    <div className="grid md:grid-cols-3 gap-8" data-oid="5js30p9">
                        {isLoading ? (
                            // Loading state
                            Array(3)
                                .fill(0)
                            ...
                            (events.length > 0 ? events : fallbackEvents).map((event, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold mb-2" data-oid="ho8vouu">
                                        {event.title}
                                    </h3>
                                    <div className="text-gray-400 mb-6" data-oid="6gf-ofe">
                                        <div className="flex items-center mb-1" data-oid="u-ho._j">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div className="flex items-center" data-oid="ca.tkz3">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5 mr-2"
                                                fill="none"
                                            ...
                                            <span data-oid="tzarqu:">{event.time} IST</span>
                                        </div>
                                    </div>
                                    <a
                    ...
                    <div className="mt-8 text-center md:hidden" data-oid="pjn.bky">
                        <a
                            href="/workshops"
            ...
            <section className="py-20 px-6 md:px-12 bg-black" data-oid="ia.cyyo">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12" data-oid="0fa9_wd">
                    <div
                        className="bg-gray-800 p-8 rounded-xl border border-gray-700"
                        data-oid="hm.m3wf"
                    >
                        <h3 className="text-2xl font-bold mb-4" data-oid="ceos7mv">
                            Subscribe to Our Newsletter
                        </h3>
                        <p className="text-gray-300 mb-6" data-oid="no.0ywu">
                            Get updates on new courses, events, and tech insights directly to your
                            inbox.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3" data-oid="omjhsq:">
                            <input
                                type="email"
                                id="newsletter-email"
                    ...
                    <div
                        ...
                        data-oid="i:an2qr"
                    >
                        <div className="flex items-center mb-6" data-oid="zjd_4lp">
                            <div
                            ...
                            <h3 className="text-2xl font-bold ml-4" data-oid="xfnumh3">
                                Join Our WhatsApp Community
                            </h3>
                        </div>
                        <p className="text-gray-300 mb-6" data-oid="hpprj7:">
            ...
            <footer
                ...
                data-oid="5k572q4"
            >
                <div className="max-w-6xl mx-auto" data-oid="2y5n_54">
                    <div className="grid md:grid-cols-4 gap-8 mb-12" data-oid="5-7zvb3">
                        <div data-oid="2f:b74s">
                            <Link href="/admin/dashboard" data-oid="ep-cehk">
                                <Image
                            ...
                            <p className="text-gray-400 mb-6 mt-4" data-oid="g6zeki2">
                                Empowering Tech Enthusiasts to Learn, Build, and Grow Together.
                            </p>
                            <div className="flex space-x-2" data-oid="kqnpua:">
                                <a
                        ...
                        <div data-oid="dtdbwjn">
                            <h4 className="text-lg font-semibold mb-4" data-oid="..doehl">
                                Quick Links
                            </h4>
                            <ul className="space-y-2" data-oid=".0c:k5a">
                                <li data-oid="kq:nvsn">
                                    <a
                                        href="/"
                        ...
                        <div data-oid="sk8jgc4">
                            <h4 className="text-lg font-semibold mb-4" data-oid="wyeax.x">
                                Resources
                            </h4>
                            <ul className="space-y-2" data-oid="7-jl9_:">
                                <li data-oid="n-ttie4">
                                    <a
                                        href="#"
                                        className="text-gray-400 hover:text-purple-400 transition-colors"
                        ...
                        <div data-oid="ae6t2:6">
                            <h4 className="text-lg font-semibold mb-4" data-oid="_ifsdt_">
                                Contact Us
                            </h4>
                            <ul className="space-y-2" data-oid="d381bs6">
                                <li className="flex items-start" data-oid=":rxu34f">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="flex items-start" data-oid="z5ua.d-">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                ...
                                <li className="flex items-start" data-oid="9gfu64s">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                    ...
                                    <span className="text-gray-400" data-oid="h5bt0l3">
                    ...
                    >
                        ...
                        <p className="text" data-oid="83dzze8">
