...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="cyr:7jf">
            {/* Navbar */}
            <nav
                className="py-4 px-6 md:px-12 flex justify-between items-center border-b border-gray-800"
                data-oid="kk92dmr"
            >
                <div className="flex items-center" data-oid="ttc5ee1">
                    <div className="relative h-10 w-32" data-oid="tswb8v4">
                        <div
                ...
                <div className="hidden md:flex items-center space-x-8" data-oid="hoybrlu">
                    <a
                        href="/"
                ...
                <div className="hidden md:flex items-center space-x-4" data-oid="pyi7ua1">
                    <a
                        href="/login"
            ...
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden bg-gray-900 p-4" data-oid="z0_y2rp">
                    <div className="flex flex-col space-y-3" data-oid="fd89ja0">
                        <a
                            href="/"
                        ...
                        <div className="pt-4 flex space-x-4" data-oid="2xaupu:">
                            <a
                                href="/login"
            ...
            >
                <div
                    ...
                    data-oid="iqoh52-"
                >
                    <div data-oid="hmgru2u">
                        <h1 className="text-4xl md:text-6xl font-bold mb-6" data-oid="q7_37yr">
                            <span
                            ...
                            <br data-oid="af-.alh" />
                            <span data-oid="ju5ytn7">With Opportunity</span>
                        </h1>
                        <p className="text-xl text-gray-300 mb-8" data-oid="b6313ox">
                            Join our community of learners and professionals to upskill, participate
                            in hackathons, and connect with industry experts.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4" data-oid="v058vbs">
                            <a
                                href="/courses"
                    ...
                    <div className="hidden md:block relative" data-oid="u38--94">
                        <div
                        ...
                        <div
                            ...
                            data-oid="mito9vu"
                        >
                            <div className="flex items-center mb-6" data-oid="hvt5-yd">
                                <div
                                ...
                                <div className="ml-4" data-oid="9n167qh">
                                    <h3 className="text-xl font-semibold" data-oid="apksap6">
                                        Learn at Your Pace
                                    </h3>
                                    <p className="text-gray-400" data-oid="xptjk0c">
                                        Access courses anytime, anywhere
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center mb-6" data-oid="xr28g7j">
                                <div
                                    className="w-12 h-12 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center"
                                    data-oid="zyqx3h8"
                                >
                                ...
                                <div className="ml-4" data-oid="qyw43ac">
                                    <h3 className="text-xl font-semibold" data-oid="k52rht7">
                                        Community Support
                                    </h3>
                                    <p className="text-gray-400" data-oid="ecyyn8f">
                                        Join WhatsApp groups for each course
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-center" data-oid="4wm84h9">
                                <div
                                    className="w-12 h-12 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center"
                                    data-oid="5dyt-id"
                                >
                                ...
                                <div className="ml-4" data-oid="faj2luz">
                                    <h3 className="text-xl font-semibold" data-oid="pfpky7h">
                                        Real-world Projects
                                    </h3>
                                    <p className="text-gray-400" data-oid="c:::4o8">
            ...
            {/* Features Section */}
            <section className="py-20 px-6 md:px-12 bg-gray-900" data-oid="l7.leup">
                <div className="max-w-6xl mx-auto" data-oid="jhlaju7">
                    <div className="text-center mb-16" data-oid="vic42.j">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="ch-o6ju">
                            Why Choose{' '}
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                data-oid="s.iw39x"
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="zf24fk2">
                            We combine learning, practice, and networking to give you the complete
                            package for tech career growth.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8" data-oid="ksz:jl_">
                        <div
                        ...
                        >
                            ...
                            <h3 className="text-xl font-semibold mb-3" data-oid=".41s8hy">
                                Industry-Relevant Curriculum
                            </h3>
                            <p className="text-gray-300" data-oid="wnbvkrt">
                        ...
                        >
                            ...
                            <h3 className="text-xl font-semibold mb-3" data-oid="i.:orrx">
                                Hands-on Hackathons
                            </h3>
                            <p className="text-gray-300" data-oid="uwnbn-_">
                        ...
                        >
                            ...
                            <h3 className="text-xl font-semibold mb-3" data-oid="n7kgb40">
                                Active Community
                            </h3>
                            <p className="text-gray-300" data-oid="z5_4b6g">
            ...
            <section className="py-20 px-6 md:px-12 bg-black" data-oid="97ap5tf">
                <div className="max-w-6xl mx-auto" data-oid="cr-0lm.">
                    <div className="flex justify-between items-end mb-12" data-oid="vja7bcv">
                        <div data-oid="vlrej-y">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="-li-dot">
                                Featured Courses
                            </h2>
                            <p className="text-xl text-gray-300" data-oid="9293j:3">
                    ...
                    <div className="grid md:grid-cols-3 gap-8" data-oid="_8t_nuf">
                        {courses.map((course, index) => (
                            <div
                                ...
                                data-oid=":6b3ht1"
                            >
                                <div className="h-48 overflow-hidden" data-oid="j-z9xkr">
                                    <img
                                        src={course.image}
                                        alt={course.title}
                                ...
                                <div className="p-6" data-oid="a3q5dgb">
                                    <div
                                        className="flex justify-between items-start mb-4"
                                        data-oid="rv_.8s."
                                    >
                                        <h3 className="text-xl font-semibold" data-oid="rw1tzbs">
                                            {course.title}
                                        </h3>
                                        <span
                                    ...
                                    <div className="flex items-center mb-4" data-oid="27umaxr">
                                        <div
                                            className="w-8 h-8 rounded-full bg-gray-600 mr-3"
                                            data-oid="6bdw3tz"
                                        ></div>
                                        <span className="text-gray-300" data-oid="hm9ptjg">
                                            {course.instructor}
                                        </span>
                                    </div>
                                    <div
                                        ...
                                        data-oid="-ybgjaq"
                                    >
                                        <span data-oid="hznl.58">{course.duration}</span>
                                        <span className="text-white font-medium" data-oid="qb4uxay">
                                            {course.price}
                                        </span>
                                    </div>
                                    <a
                    ...
                    <div className="mt-8 text-center md:hidden" data-oid="5uq0few">
                        <a
                            href="/courses"
            ...
            <section
                ...
                data-oid="zt01cl4"
            >
                <div className="max-w-6xl mx-auto" data-oid="93vnk3f">
                    <div className="text-center mb-16" data-oid="oe61svu">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="snyu4r3">
                            What Our Students Say
                        </h2>
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="7sea9nl">
                            Join thousands of satisfied learners who have transformed their careers
                            with Merge.
                        </p>
                    </div>

                    <div className="relative" data-oid="e.piv-t">
                        <div className="overflow-hidden" data-oid="1fdi_zs">
                            <div
                            ...
                            >
                                {testimonials.map((testimonial, index) => (
                                    <div key={index} className="min-w-full px-4" data-oid="2firjif">
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="ml-4" data-oid="34gs.s_">
                                                    <h3
                                                    ...
                                                    <p className="text-gray-400" data-oid="6acv10t">
                                                        {testimonial.role}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="flex justify-center mt-8 space-x-2" data-oid="x2m_ose">
            ...
            <section className="py-20 px-6 md:px-12 bg-gray-900" data-oid="s2-1l43">
                <div className="max-w-6xl mx-auto" data-oid="uww:5w3">
                    <div className="flex justify-between items-end mb-12" data-oid="mtfbu78">
                        <div data-oid="3copoy1">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="9neebg3">
                                Upcoming Events
                            </h2>
                            <p className="text-xl text-gray-300" data-oid="w..pn98">
                    ...
                    <div className="grid md:grid-cols-3 gap-8" data-oid="qee4gjw">
                        {events.map((event, index) => (
                            ...
                            >
                                ...
                                <h3 className="text-xl font-semibold mb-2" data-oid="g2cgjgl">
                                    {event.title}
                                </h3>
                                <div className="text-gray-400 mb-6" data-oid="no97ak-">
                                    <div className="flex items-center mb-1" data-oid="2ft3js3">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <span data-oid=":iv-t_t">{event.date}</span>
                                    </div>
                                    <div className="flex items-center" data-oid="zmowwfu">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className="h-5 w-5 mr-2"
                                            fill="none"
                                        ...
                                        <span data-oid="eek-ar7">{event.time}</span>
                                    </div>
                                </div>
                                <a
                    ...
                    <div className="mt-8 text-center md:hidden" data-oid="4i43ee8">
                        <a
                            href="/workshops"
                            className="text-purple-400 hover:text-purple-300 transition-colors"
                            data-oid="nci9pnr"
            ...
            <section className="py-20 px-6 md:px-12 bg-black" data-oid="3ebbd2y">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12" data-oid="8ix12lu">
                    <div
                        className="bg-gray-800 p-8 rounded-xl border border-gray-700"
                        data-oid="owyj0q:"
                    >
                        <h3 className="text-2xl font-bold mb-4" data-oid="r9v1msa">
                            Subscribe to Our Newsletter
                        </h3>
                        <p className="text-gray-300 mb-6" data-oid="om8ulfu">
                            Get updates on new courses, events, and tech insights directly to your
                            inbox.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3" data-oid="asut132">
                            <input
                                type="email"
                    ...
                    <div
                        ...
                        data-oid="poom2u3"
                    >
                        <div className="flex items-center mb-6" data-oid="64xzsd3">
                            <div
                            ...
                            <h3 className="text-2xl font-bold ml-4" data-oid="flx3bdc">
                                Join Our WhatsApp Community
                            </h3>
                        </div>
                        <p className="text-gray-300 mb-6" data-oid="xil-xmt">
            ...
            <footer
                ...
                data-oid="s:_wpc0"
            >
                <div className="max-w-6xl mx-auto" data-oid="4yb4hyo">
                    <div className="grid md:grid-cols-4 gap-8 mb-12" data-oid="w-vsni-">
                        <div data-oid="kuqqd9.">
                            <div
                            ...
                            <p className="text-gray-400 mb-6" data-oid="zen:1x-">
                                Empowering tech enthusiasts to learn, build, and grow together.
                            </p>
                            <div className="flex space-x-4" data-oid="xx65d6f">
                                <a
                                    href="#"
                        ...
                        <div data-oid="bs5f91p">
                            <h4 className="text-lg font-semibold mb-4" data-oid="-5g2og4">
                                Quick Links
                            </h4>
                            <ul className="space-y-2" data-oid="2xpv29z">
                                <li data-oid=".0cyi0e">
                                    <a
                                        href="/"
                        ...
                        <div data-oid="knoqjhq">
                            <h4 className="text-lg font-semibold mb-4" data-oid="9owohz5">
                                Resources
                            </h4>
                            <ul className="space-y-2" data-oid="tqy4586">
                                <li data-oid="urm17c:">
                                    <a
                                        href="#"
                                        className="text-gray-400 hover:text-purple-400 transition-colors"
                        ...
                        <div data-oid="vrg5jqi">
                            <h4 className="text-lg font-semibold mb-4" data-oid="2aip9t_">
                                Contact Us
                            </h4>
                            <ul className="space-y-2" data-oid="tyvhpez">
                                <li className="flex items-start" data-oid="m6d2p__">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="flex items-start" data-oid="_d4rv8y">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                ...
                                <li className="flex items-start" data-oid="gdspq-g">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                    ...
                                    <span className="text-gray-400" data-oid="h6j:b6u">
