...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="lqvs_1f">
            {/* Navbar */}
            <Navbar data-oid="eox8aen" />
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden bg-gray-900 p-4" data-oid="-4do6th">
                    <div className="flex flex-col space-y-3" data-oid="gb3sfwg">
                        <a
                            href="/"
                        ...
                        <div className="pt-4 flex space-x-4" data-oid="1ejxecu">
                            <a
                                href="/login"
            ...
            >
                ...
                <div className="relative z-10" data-oid="fqr.vbi">
                    <div
                        className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center"
                        data-oid="3bac4v3"
                    >
                        <div className="py-8" data-oid="no5rniv">
                            <h1
                            ...
                            >
                                <span
                                    ...
                                    data-oid=":26z7pv"
                                >
                                    Merge <br data-oid="u99cs7w" /> Your Skills
                                </span>
                                <br data-oid="dun::3q" />
                                <span data-oid="-b6bw_7">With Opportunity</span>
                            </h1>
                            <p
                            ...
                            <div
                                ...
                                data-oid="5o2czf7"
                            ></div>
                            <div className="flex flex-col sm:flex-row gap-4" data-oid="m7oey.9">
                                <a
                                    href="/courses"
                        ...
                        <div className="hidden md:block relative" data-oid="vtmgrke">
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="g.jhs5i">
                                        <h3
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="d0-6m-3">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="q9ibgj3"
                                        >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="f-b.19v">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="0hav8fp"
                                        >
            ...
            {/* Features Section */}
            <section className="py-8 md:py-16 px-6 md:px-12 bg-gray-900" data-oid="z56f2fr">
                <div className="max-w-6xl mx-auto" data-oid="ymm.l__">
                    <div className="text-center mb-16" data-oid="3k3j993">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="sd34x96">
                            Why Choose{' '}
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                data-oid="570-7jx"
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="w10t77c">
                            We combine learning, practice, and networking to give you the complete
                            package for tech career growth.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8" data-oid="fq5eovh">
                        <div
            ...
            <FeaturedCourses data-oid="c9m-2xl" />
            ...
            <section
                ...
                data-oid="2v1cciz"
            >
                <div className="max-w-6xl mx-auto" data-oid="kxwuyb2">
                    <div className="text-center mb-16" data-oid="ev7nifk">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="vrnpdlu">
                            What Our Students Say
                        </h2>
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="_i:urso">
                            Join thousands of satisfied learners who have transformed their careers
                            with Merge.
                        </p>
                    </div>

                    <div className="relative" data-oid=".pe:gts">
                        <div className="overflow-hidden" data-oid="d-69ufg">
                            <div
                            ...
                            >
                                {testimonials.map((testimonial, index) => (
                                    <div key={index} className="min-w-full px-4" data-oid="1wvoe25">
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="ml-4" data-oid="1lxe_0-">
                                                    <h3
                                                    ...
                                                    <p className="text-gray-400" data-oid="ojyd0r9">
                                                        {testimonial.role}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="flex justify-center mt-8 space-x-2" data-oid="zc79o-m">
            ...
            <section className="py-20 px-6 md:px-12 bg-gray-900" data-oid="8gu2g-x">
                <div className="max-w-6xl mx-auto" data-oid="326-.ti">
                    <div className="flex justify-between items-end mb-12" data-oid="ijbl2d2">
                        <div data-oid="injnfa5">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="oe.nk-a">
                                Upcoming Workshops
                            </h2>
                            <p className="text-xl text-gray-300" data-oid="sapijuz">
                    ...
                    <div className="grid md:grid-cols-3 gap-8" data-oid="i45osgo">
                        {isLoading ? (
                            // Loading state
                            Array(3)
                                .fill(0)
                            ...
                            (events.length > 0 ? events : fallbackEvents).map((event, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold mb-2" data-oid="8vrowk5">
                                        {event.title}
                                    </h3>
                                    <div className="text-gray-400 mb-6" data-oid="oij3bqa">
                                        <div className="flex items-center mb-1" data-oid="l4jkm2e">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <span data-oid="h6fk7_h">{event.date}</span>
                                        </div>
                                        <div className="flex items-center" data-oid="9-5zw-8">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5 mr-2"
                                                fill="none"
                                            ...
                                            <span data-oid="9d9xf-s">{event.time}</span>
                                        </div>
                                    </div>
                                    <a
                    ...
                    <div className="mt-8 text-center md:hidden" data-oid="t5jap92">
                        <a
                            href="/workshops"
            ...
            <section className="py-20 px-6 md:px-12 bg-black" data-oid="m3_mp.h">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12" data-oid="xl25k_r">
                    <div
                        className="bg-gray-800 p-8 rounded-xl border border-gray-700"
                        data-oid="vtetkxk"
                    >
                        <h3 className="text-2xl font-bold mb-4" data-oid="d3_j6f1">
                            Subscribe to Our Newsletter
                        </h3>
                        <p className="text-gray-300 mb-6" data-oid="z0i8qyb">
                            Get updates on new courses, events, and tech insights directly to your
                            inbox.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3" data-oid="o_qmnwa">
                            <input
                                type="email"
                                id="newsletter-email"
                    ...
                    <div
                        ...
                        data-oid="bfat3hn"
                    >
                        <div className="flex items-center mb-6" data-oid="4auj3dd">
                            <div
                            ...
                            <h3 className="text-2xl font-bold ml-4" data-oid="f:o5.ex">
                                Join Our WhatsApp Community
                            </h3>
                        </div>
                        <p className="text-gray-300 mb-6" data-oid="hc1h52_">
            ...
            <footer
                ...
                data-oid="klfi5s-"
            >
                <div className="max-w-6xl mx-auto" data-oid="sypnbew">
                    <div className="grid md:grid-cols-4 gap-8 mb-12" data-oid="7cd07a6">
                        <div data-oid="d83dj9:">
                            <Link href="/" data-oid="248v-:v">
                                <Image
                            ...
                            <p className="text-gray-400 mb-6 mt-4" data-oid="7w88nis">
                                Empowering Tech Enthusiasts to Learn, Build, and Grow Together.
                            </p>
                            <div className="flex space-x-2" data-oid="d:.xt-m">
                                <a
                        ...
                        <div data-oid="lqu6v60">
                            <h4 className="text-lg font-semibold mb-4" data-oid="91rgdwv">
                                Quick Links
                            </h4>
                            <ul className="space-y-2" data-oid="d07u12z">
                                <li data-oid="ejbr0io">
                                    <a
                                        href="/"
                        ...
                        <div data-oid="g5z9_oz">
                            <h4 className="text-lg font-semibold mb-4" data-oid="v2s.nmn">
                                Resources
                            </h4>
                            <ul className="space-y-2" data-oid="xi70clz">
                                <li data-oid=":zbg6w5">
                                    <a
                                        href="#"
                                        className="text-gray-400 hover:text-purple-400 transition-colors"
                        ...
                        <div data-oid="1wa.tl_">
                            <h4 className="text-lg font-semibold mb-4" data-oid="7ynithc">
                                Contact Us
                            </h4>
                            <ul className="space-y-2" data-oid="3_4srd4">
                                <li className="flex items-start" data-oid="_x1u9pq">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="flex items-start" data-oid="mrid24b">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                ...
                                <li className="flex items-start" data-oid="8m.qx.m">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                    ...
                                    <span className="text-gray-400" data-oid="vmr5jg8">
                    ...
                    >
                        ...
                        <p className="text" data-oid="js_mxks">
