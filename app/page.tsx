...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="3rgnez:">
            {/* Navbar */}
            <Navbar data-oid="nq:b_to" />
            <SalesBanner data-oid="553bpo1" />
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden bg-gray-900 p-4" data-oid="--ef-5r">
                    <div className="flex flex-col space-y-3" data-oid="v:dz8q_">
                        <a
                            href="/"
                        ...
                        <div className="pt-4 flex space-x-4" data-oid="4vx2c.g">
                            <a
                                href="/login"
            ...
            >
                ...
                <div className="relative z-10" data-oid="hm6n7:l">
                    <div
                        className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center"
                        data-oid="qz1ce79"
                    >
                        <div className="py-8" data-oid="-ho4ehw">
                            <h1
                            ...
                            >
                                <span
                                    ...
                                    data-oid="ath5.0."
                                >
                                    Merge <br data-oid="fwvcf8." /> Your Skills
                                </span>
                                <br data-oid="g0a_n0j" />
                                <span data-oid="wnhr5b3">With Opportunity</span>
                            </h1>
                            <p
                            ...
                            <div
                                ...
                                data-oid="43o.e:z"
                            ></div>
                            <div className="flex flex-col sm:flex-row gap-4" data-oid="vj.lf7x">
                                <a
                                    href="/courses"
                        ...
                        <div className="hidden md:block relative" data-oid="y_vk_di">
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="5o0qwpl">
                                        <h3
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="9affcf3">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="8-:o1nc"
                                        >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="wjch21x">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="g6jkeyv"
                                        >
            ...
            {/* Features Section */}
            <section className="py-8 md:py-16 px-6 md:px-12 bg-gray-900" data-oid="kx1zdu9">
                <div className="max-w-6xl mx-auto" data-oid="mlcf9ia">
                    <div className="text-center mb-16" data-oid="a6_3i_h">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="1:9b6t8">
                            Why Choose{' '}
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                data-oid="mcn-g71"
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="kftjr60">
                            We combine learning, practice, and networking to give you the complete
                            package for tech career growth.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8" data-oid="azgayt4">
                        <div
            ...
            <FeaturedCourses data-oid="t1.jhgf" />
            ...
            <section
                ...
                data-oid="ok50q_8"
            >
                <div className="max-w-6xl mx-auto" data-oid="yq0-94w">
                    <div className="text-center mb-16" data-oid="8cf_:7a">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="g-due_5">
                            What Our Students Say
                        </h2>
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="185j19_">
                            Join thousands of satisfied learners who have transformed their careers
                            with Merge.
                        </p>
                    </div>

                    <div className="relative" data-oid="2vhk.1v">
                        <div className="overflow-hidden" data-oid="zxvloks">
                            <div
                            ...
                            >
                                {testimonials.map((testimonial, index) => (
                                    <div key={index} className="min-w-full px-4" data-oid="j3v71ln">
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="ml-4" data-oid="43po.ap">
                                                    <h3
                                                    ...
                                                    <p className="text-gray-400" data-oid="1e:3rlt">
                                                        {testimonial.role}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="flex justify-center mt-8 space-x-2" data-oid="ysofwdu">
            ...
            <section className="py-20 px-6 md:px-12 bg-gray-900" data-oid="dywf3-w">
                <div className="max-w-6xl mx-auto" data-oid="upt5nql">
                    <div className="flex justify-between items-end mb-12" data-oid="qzeqm4.">
                        <div data-oid="x:.1_2r">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="zp0c13c">
                                Upcoming Workshops
                            </h2>
                            <p className="text-xl text-gray-300" data-oid="tbz0sck">
                    ...
                    <div className="grid md:grid-cols-3 gap-8" data-oid="4bfctl:">
                        {isLoading ? (
                            // Loading state
                            Array(3)
                                .fill(0)
                            ...
                            (events.length > 0 ? events : fallbackEvents).map((event, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold mb-2" data-oid="un026b4">
                                        {event.title}
                                    </h3>
                                    <div className="text-gray-400 mb-6" data-oid="6eq:z6a">
                                        <div className="flex items-center mb-1" data-oid="uat4eua">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div className="flex items-center" data-oid="8x-kuva">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5 mr-2"
                                                fill="none"
                                            ...
                                            <span data-oid="k0556fb">{event.time} IST</span>
                                        </div>
                                    </div>
                                    <a
                    ...
                    <div className="mt-8 text-center md:hidden" data-oid="y_uyltb">
                        <a
                            href="/workshops"
            ...
            <section className="py-20 px-6 md:px-12 bg-black" data-oid="ozv18en">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12" data-oid="l7978x9">
                    <div
                        className="bg-gray-800 p-8 rounded-xl border border-gray-700"
                        data-oid="w5_ceow"
                    >
                        <h3 className="text-2xl font-bold mb-4" data-oid=".rzelhy">
                            Subscribe to Our Newsletter
                        </h3>
                        <p className="text-gray-300 mb-6" data-oid="jhy6tml">
                            Get updates on new courses, events, and tech insights directly to your
                            inbox.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3" data-oid="g738xsq">
                            <input
                                type="email"
                                id="newsletter-email"
                    ...
                    <div
                        ...
                        data-oid="nq9n6iu"
                    >
                        <div className="flex items-center mb-6" data-oid="bxn_x34">
                            <div
                            ...
                            <h3 className="text-2xl font-bold ml-4" data-oid="ydkac2j">
                                Join Our WhatsApp Community
                            </h3>
                        </div>
                        <p className="text-gray-300 mb-6" data-oid="jw:w-wu">
            ...
            <footer
                ...
                data-oid="skux-8w"
            >
                <div className="max-w-6xl mx-auto" data-oid="d35lkmc">
                    <div className="grid md:grid-cols-4 gap-8 mb-12" data-oid="bduk9cn">
                        <div data-oid="f:b7nqa">
                            <Link href="/admin/dashboard" data-oid="0hxnnz:">
                                <Image
                            ...
                            <p className="text-gray-400 mb-6 mt-4" data-oid="b5l-sbo">
                                Empowering Tech Enthusiasts to Learn, Build, and Grow Together.
                            </p>
                            <div className="flex space-x-2" data-oid=".mtjjfx">
                                <a
                        ...
                        <div data-oid="2jtdrfe">
                            <h4 className="text-lg font-semibold mb-4" data-oid="-ksptw3">
                                Quick Links
                            </h4>
                            <ul className="space-y-2" data-oid="8m7kbf2">
                                <li data-oid="sp06v0o">
                                    <a
                                        href="/"
                        ...
                        <div data-oid="ooob-hc">
                            <h4 className="text-lg font-semibold mb-4" data-oid="1582war">
                                Resources
                            </h4>
                            <ul className="space-y-2" data-oid=".h29m7f">
                                <li data-oid="k_3fhfk">
                                    <a
                                        href="#"
                                        className="text-gray-400 hover:text-purple-400 transition-colors"
                        ...
                        <div data-oid="6_daqnj">
                            <h4 className="text-lg font-semibold mb-4" data-oid="jqhpfhe">
                                Contact Us
                            </h4>
                            <ul className="space-y-2" data-oid="wl916b_">
                                <li className="flex items-start" data-oid="tf.0-mx">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="flex items-start" data-oid="uaskf2u">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                ...
                                <li className="flex items-start" data-oid="u_1b74u">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                    ...
                                    <span className="text-gray-400" data-oid="frk:yhy">
                    ...
                    >
                        ...
                        <p className="text" data-oid="-ha:p7:">
