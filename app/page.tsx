...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="0f8r4lm">
            {/* Navbar */}
            <Navbar data-oid="jlm.xkf" />
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden bg-gray-900 p-4" data-oid=":.1fd..">
                    <div className="flex flex-col space-y-3" data-oid="-lxwt43">
                        <a
                            href="/"
                        ...
                        <div className="pt-4 flex space-x-4" data-oid="0megfsw">
                            <a
                                href="/login"
            ...
            >
                ...
                <div className="relative z-10" data-oid=".f.wbbj">
                    <div
                        className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center"
                        data-oid="w64g1z8"
                    >
                        <div className="py-8" data-oid="b_obuw_">
                            <h1
                            ...
                            >
                                <span
                                    ...
                                    data-oid="fu1:z3z"
                                >
                                    Merge <br data-oid="-l6-j7q" /> Your Skills
                                </span>
                                <br data-oid="k0sye0e" />
                                <span data-oid="wu.vsl6">With Opportunity</span>
                            </h1>
                            <p
                            ...
                            <div
                                ...
                                data-oid="43y:zbi"
                            ></div>
                            <div className="flex flex-col sm:flex-row gap-4" data-oid="b0qg6w3">
                                <a
                                    href="/courses"
                        ...
                        <div className="hidden md:block relative" data-oid="da7v885">
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="h7hqg2k">
                                        <h3
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="b10bsdi">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="ypvjqsh"
                                        >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="9ob_ea.">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="4fiq-e3"
                                        >
            ...
            {/* Features Section */}
            <section className="py-8 md:py-16 px-6 md:px-12 bg-gray-900" data-oid="5pl8azy">
                <div className="max-w-6xl mx-auto" data-oid=":8q5swf">
                    <div className="text-center mb-16" data-oid=":q:bwd-">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="6ghiehq">
                            Why Choose{' '}
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                data-oid="n-1xq4u"
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="syr1:8q">
                            We combine learning, practice, and networking to give you the complete
                            package for tech career growth.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8" data-oid=":w4.6gv">
                        <div
            ...
            <FeaturedCourses data-oid="ffmdzr0" />
            ...
            <section
                ...
                data-oid="x974x64"
            >
                <div className="max-w-6xl mx-auto" data-oid="7djef2a">
                    <div className="text-center mb-16" data-oid=":mhqp67">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="obqn-g6">
                            What Our Students Say
                        </h2>
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="0e2jy8_">
                            Join thousands of satisfied learners who have transformed their careers
                            with Merge.
                        </p>
                    </div>

                    <div className="relative" data-oid="w3enmwd">
                        <div className="overflow-hidden" data-oid="une7c20">
                            <div
                            ...
                            >
                                {testimonials.map((testimonial, index) => (
                                    <div key={index} className="min-w-full px-4" data-oid="bz5sies">
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="ml-4" data-oid="z9ru5yj">
                                                    <h3
                                                    ...
                                                    <p className="text-gray-400" data-oid="5uv6rqn">
                                                        {testimonial.role}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="flex justify-center mt-8 space-x-2" data-oid="maue3sq">
            ...
            <section className="py-20 px-6 md:px-12 bg-gray-900" data-oid="p4bx-p4">
                <div className="max-w-6xl mx-auto" data-oid="5rwcng9">
                    <div className="flex justify-between items-end mb-12" data-oid="w.0e80z">
                        <div data-oid="8n6zr3p">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="7jo:ok2">
                                Upcoming Workshops
                            </h2>
                            <p className="text-xl text-gray-300" data-oid="1w174sy">
                    ...
                    <div className="grid md:grid-cols-3 gap-8" data-oid="_ivxj45">
                        {isLoading ? (
                            // Loading state
                            Array(3)
                                .fill(0)
                            ...
                            (events.length > 0 ? events : fallbackEvents).map((event, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold mb-2" data-oid="_r.75iy">
                                        {event.title}
                                    </h3>
                                    <div className="text-gray-400 mb-6" data-oid="vw4-4qv">
                                        <div className="flex items-center mb-1" data-oid="lgskug4">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <span data-oid="-33jwg1">{event.date}</span>
                                        </div>
                                        <div className="flex items-center" data-oid="ve:k-42">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5 mr-2"
                                                fill="none"
                                            ...
                                            <span data-oid="4s7bd0b">{event.time}</span>
                                        </div>
                                    </div>
                                    <a
                    ...
                    <div className="mt-8 text-center md:hidden" data-oid="16g1iek">
                        <a
                            href="/workshops"
            ...
            <section className="py-20 px-6 md:px-12 bg-black" data-oid="fs6rb6s">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12" data-oid="8ip2zas">
                    <div
                        className="bg-gray-800 p-8 rounded-xl border border-gray-700"
                        data-oid="8p843p_"
                    >
                        <h3 className="text-2xl font-bold mb-4" data-oid="qywq5k5">
                            Subscribe to Our Newsletter
                        </h3>
                        <p className="text-gray-300 mb-6" data-oid="hk:l381">
                            Get updates on new courses, events, and tech insights directly to your
                            inbox.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3" data-oid="jwzp5b3">
                            <input
                                type="email"
                                id="newsletter-email"
                    ...
                    <div
                        ...
                        data-oid="b-gxxye"
                    >
                        <div className="flex items-center mb-6" data-oid="y9ju0z-">
                            <div
                            ...
                            <h3 className="text-2xl font-bold ml-4" data-oid="axthbg6">
                                Join Our WhatsApp Community
                            </h3>
                        </div>
                        <p className="text-gray-300 mb-6" data-oid="52ib-1j">
            ...
            <footer
                ...
                data-oid="7r-2:9w"
            >
                <div className="max-w-6xl mx-auto" data-oid="y9dqmn8">
                    <div className="grid md:grid-cols-4 gap-8 mb-12" data-oid="nipvbn4">
                        <div data-oid="judhxku">
                            <Link href="/admin/dashboard" data-oid="at9z_s.">
                                <Image
                            ...
                            <p className="text-gray-400 mb-6 mt-4" data-oid="oz78vxq">
                                Empowering Tech Enthusiasts to Learn, Build, and Grow Together.
                            </p>
                            <div className="flex space-x-2" data-oid="loab1c_">
                                <a
                        ...
                        <div data-oid="r58852_">
                            <h4 className="text-lg font-semibold mb-4" data-oid="r3tgcaj">
                                Quick Links
                            </h4>
                            <ul className="space-y-2" data-oid="f0t3l._">
                                <li data-oid="ov83ugy">
                                    <a
                                        href="/"
                        ...
                        <div data-oid="-g._5in">
                            <h4 className="text-lg font-semibold mb-4" data-oid="557mbcg">
                                Resources
                            </h4>
                            <ul className="space-y-2" data-oid="k9kdudt">
                                <li data-oid="svwljt3">
                                    <a
                                        href="#"
                                        className="text-gray-400 hover:text-purple-400 transition-colors"
                        ...
                        <div data-oid="hi5ymbn">
                            <h4 className="text-lg font-semibold mb-4" data-oid=":0htdar">
                                Contact Us
                            </h4>
                            <ul className="space-y-2" data-oid="8wh2a_9">
                                <li className="flex items-start" data-oid="hpfiw0e">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="flex items-start" data-oid="0mum:hd">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                ...
                                <li className="flex items-start" data-oid="3ot9rtf">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                    ...
                                    <span className="text-gray-400" data-oid="8m5r5i0">
                    ...
                    >
                        ...
                        <p className="text" data-oid="ch0r:a2">
