...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="6_5gm75">
            {/* Navbar */}
            <Navbar data-oid="vvx0xyx" />
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden bg-gray-900 p-4" data-oid="p_4cbcb">
                    <div className="flex flex-col space-y-3" data-oid="ojf48eq">
                        <a
                            href="/"
                        ...
                        <div className="pt-4 flex space-x-4" data-oid="6llu0jv">
                            <a
                                href="/login"
            ...
            >
                ...
                <div className="relative z-10" data-oid="yjp.r27">
                    <div
                        className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center"
                        data-oid="3hjav-4"
                    >
                        <div className="py-8" data-oid="c.90of8">
                            <h1
                            ...
                            >
                                <span
                                    ...
                                    data-oid="06r98oq"
                                >
                                    Merge <br data-oid="z9q.jkc" /> Your Skills
                                </span>
                                <br data-oid="__.dihk" />
                                <span data-oid="l0go42e">With Opportunity</span>
                            </h1>
                            <p
                            ...
                            <div
                                ...
                                data-oid="wieyiah"
                            ></div>
                            <div className="flex flex-col sm:flex-row gap-4" data-oid="y2oy58g">
                                <a
                                    href="/courses"
                        ...
                        <div className="hidden md:block relative" data-oid="j8zcyu3">
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="ahp5a2q">
                                        <h3
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="hkj_lnv">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="sxrwg7a"
                                        >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="54pm._l">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid=".fyb9_u"
                                        >
            ...
            {/* Features Section */}
            <section className="py-8 md:py-16 px-6 md:px-12 bg-gray-900" data-oid="rwc6v:i">
                <div className="max-w-6xl mx-auto" data-oid="9_:.2:8">
                    <div className="text-center mb-16" data-oid="zyzsfo1">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="pkqu-pp">
                            Why Choose{' '}
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                data-oid="phiesso"
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="l093ma6">
                            We combine learning, practice, and networking to give you the complete
                            package for tech career growth.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8" data-oid="lw8rxm5">
                        <div
            ...
            <FeaturedCourses data-oid="n1blsqb" />
            ...
            <section
                ...
                data-oid="6r.3:nk"
            >
                <div className="max-w-6xl mx-auto" data-oid="b11-z:a">
                    <div className="text-center mb-16" data-oid="6_21anu">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="5lu_jmc">
                            What Our Students Say
                        </h2>
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="jf6fhng">
                            Join thousands of satisfied learners who have transformed their careers
                            with Merge.
                        </p>
                    </div>

                    <div className="relative" data-oid="yd9i7n:">
                        <div className="overflow-hidden" data-oid="mid.l3q">
                            <div
                            ...
                            >
                                {testimonials.map((testimonial, index) => (
                                    <div key={index} className="min-w-full px-4" data-oid="16.yh4n">
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="ml-4" data-oid="i755l1s">
                                                    <h3
                                                    ...
                                                    <p className="text-gray-400" data-oid="kez3aei">
                                                        {testimonial.role}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="flex justify-center mt-8 space-x-2" data-oid="01as:d3">
            ...
            <section className="py-20 px-6 md:px-12 bg-gray-900" data-oid="2ej4c1y">
                <div className="max-w-6xl mx-auto" data-oid="i24v-6u">
                    <div className="flex justify-between items-end mb-12" data-oid="4r61::c">
                        <div data-oid="k4f-z4r">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="l3tjbyz">
                                Upcoming Workshops
                            </h2>
                            <p className="text-xl text-gray-300" data-oid="944qtm_">
                    ...
                    <div className="grid md:grid-cols-3 gap-8" data-oid="p90m.ml">
                        {isLoading ? (
                            // Loading state
                            Array(3)
                                .fill(0)
                            ...
                            (events.length > 0 ? events : fallbackEvents).map((event, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold mb-2" data-oid="cr_7afr">
                                        {event.title}
                                    </h3>
                                    <div className="text-gray-400 mb-6" data-oid="7gn-jm0">
                                        <div className="flex items-center mb-1" data-oid="te4:d4p">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <span data-oid="mr2vsca">{event.date}</span>
                                        </div>
                                        <div className="flex items-center" data-oid=":rshoih">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5 mr-2"
                                                fill="none"
                                            ...
                                            <span data-oid="fjlieno">{event.time}</span>
                                        </div>
                                    </div>
                                    <a
                    ...
                    <div className="mt-8 text-center md:hidden" data-oid="zh95v34">
                        <a
                            href="/workshops"
            ...
            <section className="py-20 px-6 md:px-12 bg-black" data-oid="rr3.3k.">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12" data-oid="ktgiyu_">
                    <div
                        className="bg-gray-800 p-8 rounded-xl border border-gray-700"
                        data-oid="uy954.f"
                    >
                        <h3 className="text-2xl font-bold mb-4" data-oid="8jn9b28">
                            Subscribe to Our Newsletter
                        </h3>
                        <p className="text-gray-300 mb-6" data-oid="lvghyyq">
                            Get updates on new courses, events, and tech insights directly to your
                            inbox.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3" data-oid="nsjbx2b">
                            <input
                                type="email"
                                id="newsletter-email"
                    ...
                    <div
                        ...
                        data-oid="yzj0lka"
                    >
                        <div className="flex items-center mb-6" data-oid="wi3xpfo">
                            <div
                            ...
                            <h3 className="text-2xl font-bold ml-4" data-oid="kdju8ix">
                                Join Our WhatsApp Community
                            </h3>
                        </div>
                        <p className="text-gray-300 mb-6" data-oid="q7t204f">
                ...
                <div className="max-w-6xl mx-auto" data-oid="fi.d9op">
                    <div className="grid md:grid-cols-4 gap-8 mb-12" data-oid="q_-2cqz">
                        <div data-oid="b5220gh">
                            ...
                            <p className="text-gray-400 mb-6 mt-4" data-oid="va7_y.n">
                                Empowering Tech Enthusiasts to Learn, Build, and Grow Together.
                            </p>
                            <div className="flex space-x-2" data-oid="4yh86-t">
                                <a
                        ...
                        <div data-oid="q.5j_u8">
                            <h4 className="text-lg font-semibold mb-4" data-oid="o7:zzoh">
                                Quick Links
                            </h4>
                            <ul className="space-y-2" data-oid="u8t0t.3">
                                <li data-oid="bcufs8p">
                                    <a
                                        href="/"
                        ...
                        <div data-oid="bokdpn:">
                            <h4 className="text-lg font-semibold mb-4" data-oid="x6m7wmu">
                                Resources
                            </h4>
                            <ul className="space-y-2" data-oid="4vg5m_6">
                                <li data-oid="4dm1kk_">
                                    <a
                                        href="#"
                                        className="text-gray-400 hover:text-purple-400 transition-colors"
                        ...
                        <div data-oid="az0-5g5">
                            <h4 className="text-lg font-semibold mb-4" data-oid="87ofpp9">
                                Contact Us
                            </h4>
                            <ul className="space-y-2" data-oid=".hyfv01">
                                <li className="flex items-start" data-oid="sdi_yew">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="flex items-start" data-oid="g8_514k">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                ...
                                <li className="flex items-start" data-oid="axa_tm5">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                    ...
                                    <span className="text-gray-400" data-oid="0687b-2">
                    ...
                    >
                        ...
                        <p className="text" data-oid="_7_ac8b">
