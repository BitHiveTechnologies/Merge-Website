...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans pt-20" data-oid="3xiirnt">
            {/* Navbar */}
            <Navbar data-oid="z1jhzc3" />
            {/* Mobile Menu */}
            {isMenuOpen && (
                <div className="md:hidden bg-gray-900 p-4" data-oid="cj1dtzl">
                    <div className="flex flex-col space-y-3" data-oid="t:7-i-9">
                        <a
                            href="/"
                        ...
                        <div className="pt-4 flex space-x-4" data-oid="sxrnq9y">
                            <a
                                href="/login"
            ...
            >
                ...
                <div className="relative z-10" data-oid="tjvhbdr">
                    <div
                        className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center"
                        data-oid="nizkclq"
                    >
                        <div className="py-8" data-oid="roy_my8">
                            <h1
                            ...
                            >
                                <span
                                    ...
                                    data-oid="w3av3ns"
                                >
                                    Merge <br data-oid="njqwul6" /> Your Skills
                                </span>
                                <br data-oid="_j1ppib" />
                                <span data-oid="75b:gir">With Opportunity</span>
                            </h1>
                            <p
                            ...
                            <div
                                ...
                                data-oid="w7a-67u"
                            ></div>
                            <div className="flex flex-col sm:flex-row gap-4" data-oid=":tad0:i">
                                <a
                                    href="/courses"
                        ...
                        <div className="hidden md:block relative" data-oid="apv_x6k">
                            <div
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="h63p0.8">
                                        <h3
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="fa3dbrj">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="9w95jbh"
                                        >
                                ...
                                >
                                    ...
                                    <div className="ml-4" data-oid="1p2vdhy">
                                        <h3
                                            className="text-xl font-semibold group-hover:text-purple-300 transition-colors duration-300"
                                            data-oid="b9fnxhr"
                                        >
            ...
            {/* Features Section */}
            <section className="py-8 md:py-16 px-6 md:px-12 bg-gray-900" data-oid="7wz50e7">
                <div className="max-w-6xl mx-auto" data-oid="25ojbua">
                    <div className="text-center mb-16" data-oid="_sy8slz">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="nebh8v2">
                            Why Choose{' '}
                            <span
                                className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500"
                                data-oid="he5kjrk"
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid=".2l2uuo">
                            We combine learning, practice, and networking to give you the complete
                            package for tech career growth.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8" data-oid="t5yyert">
                        <div
            ...
            <FeaturedCourses data-oid="ev9rbwr" />
            ...
            <section
                ...
                data-oid="r_0l6sw"
            >
                <div className="max-w-6xl mx-auto" data-oid=":-.gobe">
                    <div className="text-center mb-16" data-oid="dsl:v_n">
                        <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="8vtcfyh">
                            What Our Students Say
                        </h2>
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto" data-oid="lut6ucu">
                            Join thousands of satisfied learners who have transformed their careers
                            with Merge.
                        </p>
                    </div>

                    <div className="relative" data-oid="ys9sfra">
                        <div className="overflow-hidden" data-oid="9m:.8rc">
                            <div
                            ...
                            >
                                {testimonials.map((testimonial, index) => (
                                    <div key={index} className="min-w-full px-4" data-oid="z2q93rb">
                                        <div
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <div className="ml-4" data-oid="9_kowi-">
                                                    <h3
                                                    ...
                                                    <p className="text-gray-400" data-oid="8w.n2hk">
                                                        {testimonial.role}
                                                    </p>
                                                </div>
                                            </div>
                        ...
                        <div className="flex justify-center mt-8 space-x-2" data-oid="9ic_86j">
            ...
            <section className="py-20 px-6 md:px-12 bg-gray-900" data-oid="wd4pltn">
                <div className="max-w-6xl mx-auto" data-oid="ut-ttko">
                    <div className="flex justify-between items-end mb-12" data-oid="_83rfp_">
                        <div data-oid="20:dsb:">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-oid="xaznogu">
                                Upcoming Workshops
                            </h2>
                            <p className="text-xl text-gray-300" data-oid=":f_y8lo">
                    ...
                    <div className="grid md:grid-cols-3 gap-8" data-oid="y9oeb5j">
                        {isLoading ? (
                            // Loading state
                            Array(3)
                                .fill(0)
                            ...
                            (events.length > 0 ? events : fallbackEvents).map((event, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="text-xl font-semibold mb-2" data-oid="sla04f7">
                                        {event.title}
                                    </h3>
                                    <div className="text-gray-400 mb-6" data-oid="e5trbo5">
                                        <div className="flex items-center mb-1" data-oid="d97oepg">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <span data-oid="96hqinh">{event.date}</span>
                                        </div>
                                        <div className="flex items-center" data-oid="gd219uc">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="h-5 w-5 mr-2"
                                                fill="none"
                                            ...
                                            <span data-oid="c:i55r:">{event.time}</span>
                                        </div>
                                    </div>
                                    <a
                    ...
                    <div className="mt-8 text-center md:hidden" data-oid="ii02c_2">
                        <a
                            href="/workshops"
            ...
            <section className="py-20 px-6 md:px-12 bg-black" data-oid="j64u3tm">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12" data-oid=":dc874v">
                    <div
                        className="bg-gray-800 p-8 rounded-xl border border-gray-700"
                        data-oid="f4fsoda"
                    >
                        <h3 className="text-2xl font-bold mb-4" data-oid="kfzfn9u">
                            Subscribe to Our Newsletter
                        </h3>
                        <p className="text-gray-300 mb-6" data-oid="58j3fjj">
                            Get updates on new courses, events, and tech insights directly to your
                            inbox.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-3" data-oid="rfnyocx">
                            <input
                                type="email"
                                id="newsletter-email"
                    ...
                    <div
                        ...
                        data-oid="94-2.8y"
                    >
                        <div className="flex items-center mb-6" data-oid="uhrfme7">
                            <div
                            ...
                            <h3 className="text-2xl font-bold ml-4" data-oid=".z6jxg7">
                                Join Our WhatsApp Community
                            </h3>
                        </div>
                        <p className="text-gray-300 mb-6" data-oid="tn6tdl-">
            ...
            <footer
                ...
                data-oid="2o-.xhq"
            >
                <div className="max-w-6xl mx-auto" data-oid="sfgy_fz">
                    <div className="grid md:grid-cols-4 gap-8 mb-12" data-oid="xv.03qo">
                        <div data-oid="grycb2a">
                            <Link href="/" data-oid="-df9_jh">
                                <Image
                            ...
                            <p className="text-gray-400 mb-6 mt-4" data-oid="hv.ts0t">
                                Empowering Tech Enthusiasts to Learn, Build, and Grow Together.
                            </p>
                            <div className="flex space-x-2" data-oid="xuceluv">
                                <a
                        ...
                        <div data-oid="jvjn1om">
                            <h4 className="text-lg font-semibold mb-4" data-oid="lgus7dj">
                                Quick Links
                            </h4>
                            <ul className="space-y-2" data-oid="j:s6jo:">
                                <li data-oid="a.h5lv7">
                                    <a
                                        href="/"
                        ...
                        <div data-oid="qrvk.bh">
                            <h4 className="text-lg font-semibold mb-4" data-oid="qyncb7t">
                                Resources
                            </h4>
                            <ul className="space-y-2" data-oid="vv:piaz">
                                <li data-oid="wz21gwa">
                                    <a
                                        href="#"
                                        className="text-gray-400 hover:text-purple-400 transition-colors"
                        ...
                        <div data-oid="yaf:wb-">
                            <h4 className="text-lg font-semibold mb-4" data-oid="9_fml3.">
                                Contact Us
                            </h4>
                            <ul className="space-y-2" data-oid="jmpaltj">
                                <li className="flex items-start" data-oid="tctdcpa">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li className="flex items-start" data-oid="h9fovh-">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                ...
                                <li className="flex items-start" data-oid="t7vuy4t">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5 mr-2 text-gray-400"
                                        fill="none"
                                    ...
                                    <span className="text-gray-400" data-oid="9xdnd-4">
                    ...
                    >
                        ...
                        <p className="text" data-oid="dxtxi:b">
