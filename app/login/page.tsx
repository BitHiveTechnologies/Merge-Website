...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="ay.:357">
            <Navbar data-oid="lxv.rg8" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="ztav-h1">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden  mt-12"
                    data-oid="zes25.-"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="0p64zfc">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="mmknnn7">
                        <div className="text-center mb-6" data-oid="k3khk76">
                            <h1 className="text-3xl font-bold mb-2" data-oid="_0fetqk">
                                Welcome Back
                            </h1>
                            <p className="text-gray-400" data-oid="_dj1:qx">
                        ...
                        <form onSubmit={handleSubmit} data-oid="4jn_slr">
                            <div className="mb-6" data-oid="c6rz_i8">
                                <label
                                    htmlFor="email"
                            ...
                            <div className="mb-6" data-oid="nq_ln50">
                                <div
                                ...
                                <div className="relative" data-oid="8qb2hy1">
                                    <input
                                        id="password"
                            ...
                            <div className="flex items-center mb-6" data-oid="afe6yt5">
                                <input
                                    id="remember-me"
                                    type="checkbox"
                                    checked={rememberMe}
                        ...
                        <div className="mt-6 text-center" data-oid="wbefs_f">
                            <p className="text-gray-400" data-oid="zy-g3zv">
