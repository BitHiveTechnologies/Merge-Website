...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid=":43v7k0">
            <Navbar data-oid="kpney_3" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="favm9un">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden  mt-12"
                    data-oid=".i_d7o8"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="v92zpo5">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid=".hrw-w.">
                        <div className="text-center mb-6" data-oid="_wyp2ir">
                            <h1 className="text-3xl font-bold mb-2" data-oid="c_vf8zl">
                                Welcome Back
                            </h1>
                            <p className="text-gray-400" data-oid="sl4y-sn">
                        ...
                        <form onSubmit={handleSubmit} data-oid="55s-8e2">
                            <div className="mb-6" data-oid="5u-r4g2">
                                <label
                                    htmlFor="email"
                            ...
                            <div className="mb-6" data-oid="d2apkih">
                                <div
                                ...
                                <div className="relative" data-oid="plut1l8">
                                    <input
                                        id="password"
                            ...
                            <div className="flex items-center mb-6" data-oid="s7_iipl">
                                <input
                                    id="remember-me"
                                    type="checkbox"
                                    checked={rememberMe}
                        ...
                        <div className="mt-6 text-center" data-oid="oyx4w4u">
                            <p className="text-gray-400" data-oid="xn07iqt">
