...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="nw4g.v7">
            <Navbar data-oid="g73pxxz" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="5zf.2tw">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden  mt-12"
                    data-oid="6.j02sh"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="fekz8tv">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="nn9kq4i">
                        <div className="text-center mb-6" data-oid=".umjmam">
                            <h1 className="text-3xl font-bold mb-2" data-oid="51jr5cu">
                                Welcome Back
                            </h1>
                            <p className="text-gray-400" data-oid="zq:-uzi">
                        ...
                        <form onSubmit={handleSubmit} data-oid=".to9u9_">
                            <div className="mb-6" data-oid="ayk-tgm">
                                <label
                                    htmlFor="email"
                            ...
                            <div className="mb-6" data-oid="28xqioq">
                                <div
                                ...
                                <div className="relative" data-oid=".bxfxmj">
                                    <input
                                        id="password"
                            ...
                            <div className="flex items-center mb-6" data-oid="76.i02t">
                                <input
                                    id="remember-me"
                                    type="checkbox"
                                    checked={rememberMe}
                        ...
                        <div className="mt-6 text-center" data-oid="joaseut">
                            <p className="text-gray-400" data-oid="cjp3zix">
