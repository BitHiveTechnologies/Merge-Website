...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="ruc_ddd">
            <Navbar data-oid="9nekioz" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="cn5kqf5">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden  mt-12"
                    data-oid="i7y5wq9"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="zix3n:3">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="6vp93gq">
                        <div className="text-center mb-6" data-oid="622wuq3">
                            <h1 className="text-3xl font-bold mb-2" data-oid="8bk_28_">
                                Welcome Back
                            </h1>
                            <p className="text-gray-400" data-oid="xfc93wn">
                        ...
                        <form onSubmit={handleSubmit} data-oid="ds9a2gt">
                            <div className="mb-6" data-oid="xsu94ky">
                                <label
                                    htmlFor="email"
                            ...
                            <div className="mb-6" data-oid="xxf:9.d">
                                <div
                                ...
                                <div className="relative" data-oid="q9b-x76">
                                    <input
                                        id="password"
                            ...
                            <div className="flex items-center mb-6" data-oid="lfiibk3">
                                <input
                                    id="remember-me"
                                    type="checkbox"
                                    checked={rememberMe}
                        ...
                        <div className="mt-6 text-center" data-oid="u_-tsq.">
                            <p className="text-gray-400" data-oid="qewexrs">
