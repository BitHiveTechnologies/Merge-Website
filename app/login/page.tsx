...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="x0-wn70">
            <Navbar data-oid="j0aazit" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="4a6kaov">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden  mt-12"
                    data-oid=".zlf7-g"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="_02pocw">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="41euc5u">
                        <div className="text-center mb-6" data-oid="opt6t72">
                            <h1 className="text-3xl font-bold mb-2" data-oid="i8n92al">
                                Welcome Back
                            </h1>
                            <p className="text-gray-400" data-oid="7ijmi.u">
                        ...
                        <form onSubmit={handleSubmit} data-oid="97tm.iy">
                            <div className="mb-6" data-oid="zc25-bd">
                                <label
                                    htmlFor="email"
                            ...
                            <div className="mb-6" data-oid="sp4edq.">
                                <div
                                ...
                                <div className="relative" data-oid="u:l0_ev">
                                    <input
                                        id="password"
                            ...
                            <div className="flex items-center mb-6" data-oid="ijqlc12">
                                <input
                                    id="remember-me"
                                    type="checkbox"
                                    checked={rememberMe}
                        ...
                        <div className="mt-6 text-center" data-oid="kr5.o_q">
                            <p className="text-gray-400" data-oid="xv719ag">
