...
export default function HackathonRegistrationsPage() {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-[50vh]" data-oid="4hv7kjb">
                <div
    ...
    if (error) {
        return (
            <div
                ...
                data-oid="ytgb6ex"
            >
                <p className="text-red-200" data-oid="v_-ysy2">
                    {error}
                </p>
                <button
    ...
    return (
        <div data-oid="i96sik7">
            <div className="flex justify-between items-center mb-6" data-oid="g:nz.mc">
                <div data-oid="zuhstgb">
                    <Link
                        href="/admin/dashboard"
                        className="text-purple-400 hover:text-purple-300 border border-purple-500 hover:border-purple-400 rounded-lg px-4 py-2 transition-all duration-300 mb-4 inline-flex items-center"
                        data-oid="4euh0ay"
                    >
                        <span className="mr-1" data-oid="p3bh1lc">
                            ←
                        </span>{' '}
                        Back to Dashboard
                    </Link>
                    <h1 className="text-3xl font-bold" data-oid="2m.65ev">
                        {hackathon ? hackathon.title : 'Hackathon'} Registrations
                    </h1>
                    {hackathon && (
                        <p className="text-gray-400 mt-1" data-oid="76rom7r">
            ...
            {registrations.length === 0 ? (
                <div
                    ...
                    data-oid="us:pr04"
                >
                    <p className="text-gray-400" data-oid="4ae4-fu">
                ...
                <div
                    ...
                    data-oid=".6b2dba"
                >
                    <div className="overflow-x-auto" data-oid="r--sax0">
                        <table className="min-w-full divide-y divide-gray-700" data-oid="_xbb.d2">
                            <thead className="bg-gray-900" data-oid="4hr02.z">
                                <tr data-oid="vxkb_ko">
                                    <th
                                        scope="col"
