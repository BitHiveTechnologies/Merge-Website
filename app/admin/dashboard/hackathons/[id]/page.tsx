...
export default function HackathonRegistrationsPage() {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-[50vh]" data-oid="5zqrt4l">
                <div
    ...
    if (error) {
        return (
            <div
                ...
                data-oid="rr-dre:"
            >
                <p className="text-red-200" data-oid="4rsnpt6">
                    {error}
                </p>
                <button
    ...
    return (
        <div data-oid="g9uucf7">
            <div className="flex justify-between items-center mb-6" data-oid="_c2ntwg">
                <div data-oid="u3g.x-o">
                    <Link
                        href="/admin/dashboard"
                        className="text-purple-400 hover:text-purple-300 border border-purple-500 hover:border-purple-400 rounded-lg px-4 py-2 transition-all duration-300 mb-4 inline-flex items-center"
                        data-oid="m3qx4sm"
                    >
                        <span className="mr-1" data-oid="irkhu:r">
                            ←
                        </span>{' '}
                        Back to Dashboard
                    </Link>
                    <h1 className="text-3xl font-bold" data-oid=":_tmjub">
                        {hackathon ? hackathon.title : 'Hackathon'} Registrations
                    </h1>
                    {hackathon && (
                        <p className="text-gray-400 mt-1" data-oid="0l1h0as">
            ...
            {registrations.length === 0 ? (
                <div
                    ...
                    data-oid="65q8g.:"
                >
                    <p className="text-gray-400" data-oid="7c4c62u">
                ...
                <div
                    ...
                    data-oid="4b4ym74"
                >
                    <div className="overflow-x-auto" data-oid="_cuao6p">
                        <table className="min-w-full divide-y divide-gray-700" data-oid="saifx6s">
                            <thead className="bg-gray-900" data-oid="_ty8qbl">
                                <tr data-oid="t:b5:fj">
                                    <th
                                        scope="col"
