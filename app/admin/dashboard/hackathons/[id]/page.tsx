...
export default function HackathonRegistrationsPage() {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-[50vh]" data-oid="ynmatlz">
                <div
    ...
    if (error) {
        return (
            <div
                ...
                data-oid="y0x7suw"
            >
                <p className="text-red-200" data-oid="hg30ynv">
                    {error}
                </p>
                <button
    ...
    return (
        <div data-oid=".4ld:vt">
            <div className="flex justify-between items-center mb-6" data-oid=":3c336k">
                <div data-oid="5vc3oqe">
                    <Link
                        href="/admin/dashboard"
                        className="text-purple-400 hover:text-purple-300 border border-purple-500 hover:border-purple-400 rounded-lg px-4 py-2 transition-all duration-300 mb-4 inline-flex items-center"
                        data-oid="i9lohhf"
                    >
                        <span className="mr-1" data-oid=".43kcy7">
                            ←
                        </span>{' '}
                        Back to Dashboard
                    </Link>
                    <h1 className="text-3xl font-bold" data-oid="m:nxa9:">
                        {hackathon ? hackathon.title : 'Hackathon'} Registrations
                    </h1>
                    {hackathon && (
                        <p className="text-gray-400 mt-1" data-oid="fl:7i9p">
            ...
            {registrations.length === 0 ? (
                <div
                    ...
                    data-oid="d05efq_"
                >
                    <p className="text-gray-400" data-oid="nl50uhc">
                ...
                <div
                    ...
                    data-oid="jo2lelu"
                >
                    <div className="overflow-x-auto" data-oid=":z4j8rb">
                        <table className="min-w-full divide-y divide-gray-700" data-oid="fvl_j:s">
                            <thead className="bg-gray-900" data-oid="lb67ix:">
                                <tr data-oid="uv6du4o">
                                    <th
                                        scope="col"
