...
export default function HackathonRegistrationsPage() {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-[50vh]" data-oid="n279da6">
                <div
    ...
    if (error) {
        return (
            <div
                ...
                data-oid="cleo2k4"
            >
                <p className="text-red-200" data-oid="8:awgqe">
                    {error}
                </p>
                <button
    ...
    return (
        <div data-oid="id4qqkw">
            <div className="flex justify-between items-center mb-6" data-oid="j-o0lb-">
                <div data-oid="jty5f88">
                    <Link
                        href="/admin/dashboard"
                        className="text-purple-400 hover:text-purple-300 border border-purple-500 hover:border-purple-400 rounded-lg px-4 py-2 transition-all duration-300 mb-4 inline-flex items-center"
                        data-oid="9uo3bzf"
                    >
                        <span className="mr-1" data-oid="_lfygsu">
                            ←
                        </span>{' '}
                        Back to Dashboard
                    </Link>
                    <h1 className="text-3xl font-bold" data-oid="svav6z2">
                        {hackathon ? hackathon.title : 'Hackathon'} Registrations
                    </h1>
                    {hackathon && (
                        <p className="text-gray-400 mt-1" data-oid="m-1lwbk">
            ...
            {registrations.length === 0 ? (
                <div
                    ...
                    data-oid="gcfl5w9"
                >
                    <p className="text-gray-400" data-oid="vxyachi">
                ...
                <div
                    ...
                    data-oid="j6741ow"
                >
                    <div className="overflow-x-auto" data-oid="4ha6fyt">
                        <table className="min-w-full divide-y divide-gray-700" data-oid="fuz1lkf">
                            <thead className="bg-gray-900" data-oid="6wrco49">
                                <tr data-oid="dgjew8o">
                                    <th
                                        scope="col"
