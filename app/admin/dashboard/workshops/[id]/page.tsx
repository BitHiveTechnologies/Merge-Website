...
export default function WorkshopRegistrationsPage() {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-[50vh]" data-oid="b_ila-k">
                <div
    ...
    if (error) {
        return (
            <div
                ...
                data-oid="7utdhy3"
            >
                <p className="text-red-200" data-oid="4jjo.e.">
                    {error}
                </p>
                <button
    ...
    return (
        <div data-oid="sbcbvwh">
            <div className="flex justify-between items-center mb-6" data-oid="k7qn4ny">
                <div data-oid="g.9gsm8">
                    <Link
                        href="/admin/dashboard"
                        className="text-purple-400 hover:text-purple-300 border border-purple-500 hover:border-purple-400 rounded-lg px-4 py-2 transition-all duration-300 mb-4 inline-flex items-center"
                        data-oid="8n5_c2n"
                    >
                        <span className="mr-1" data-oid="apuk5g1">
                            ←
                        </span>{' '}
                        Back to Dashboard
                    </Link>
                    <h1 className="text-3xl font-bold" data-oid="98zju:w">
                        {workshop ? workshop.title : 'Workshop'} Registrations
                    </h1>
                    {workshop && (
                        <p className="text-gray-400 mt-1" data-oid="zt32v4w">
            ...
            {registrations.length === 0 ? (
                <div
                    ...
                    data-oid="beqw_qt"
                >
                    <p className="text-gray-400" data-oid="ej9kaqi">
                ...
                <div
                    ...
                    data-oid="e:v8u_c"
                >
                    <div className="overflow-x-auto" data-oid="vlz48my">
                        <table className="min-w-full divide-y divide-gray-700" data-oid="5wms.u5">
                            <thead className="bg-gray-900" data-oid="kxcsl_x">
                                <tr data-oid="5lagnpe">
                                    <th
                                        scope="col"
