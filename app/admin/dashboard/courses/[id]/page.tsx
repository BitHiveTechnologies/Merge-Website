...
export default function CourseRegistrationsPage() {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-[50vh]" data-oid="sm6t3c9">
                <div
    ...
    if (error) {
        return (
            <div
                ...
                data-oid="vem7le-"
            >
                <p className="text-red-200" data-oid="093x5pk">
                    {error}
                </p>
                <button
    ...
    return (
        <div data-oid="_pjkzil">
            <div className="flex justify-between items-center mb-6" data-oid=":nj:54e">
                <div data-oid="3o-reud">
                    <Link
                        href="/admin/dashboard"
                        className="text-purple-400 hover:text-purple-300 border border-purple-500 hover:border-purple-400 rounded-lg px-4 py-2 transition-all duration-300 mb-4 inline-flex items-center"
                        data-oid="3wduutx"
                    >
                        <span className="mr-1" data-oid="xhveh2o">
                            ←
                        </span>{' '}
                        Back to Dashboard
                    </Link>
                    <h1 className="text-3xl font-bold" data-oid="e9tthfu">
            ...
            {registrations.length === 0 ? (
                <div
                    ...
                    data-oid="ycq1.1k"
                >
                    <p className="text-gray-400" data-oid="dq-z16y">
                ...
                <div
                    ...
                    data-oid="usvfz.4"
                >
                    <div className="overflow-x-auto" data-oid="ims3wis">
                        <table className="min-w-full divide-y divide-gray-700" data-oid="rmcf341">
                            <thead className="bg-gray-900" data-oid="ath-656">
                                <tr data-oid="cl_ly-z">
                                    <th
                                        scope="col"
