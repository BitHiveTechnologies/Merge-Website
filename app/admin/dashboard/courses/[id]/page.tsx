...
export default function CourseRegistrationsPage() {
    ...
    if (loading) {
        return (
            <div className="flex justify-center items-center min-h-[50vh]" data-oid=":36_uvd">
                <div
    ...
    if (error) {
        return (
            <div
                ...
                data-oid="t0__3yv"
            >
                <p className="text-red-200" data-oid="0h7li5m">
                    {error}
                </p>
                <button
    ...
    return (
        <div data-oid="sw_:rrl">
            <div className="flex justify-between items-center mb-6" data-oid="u6xrq0.">
                <div data-oid="pn3hv31">
                    <Link
                        href="/admin/dashboard"
                        className="text-purple-400 hover:text-purple-300 border border-purple-500 hover:border-purple-400 rounded-lg px-4 py-2 transition-all duration-300 mb-4 inline-flex items-center"
                        data-oid="gtkes9m"
                    >
                        <span className="mr-1" data-oid="i-l4.5t">
                            ←
                        </span>{' '}
                        Back to Dashboard
                    </Link>
                    <h1 className="text-3xl font-bold" data-oid="m12z2el">
            ...
            {registrations.length === 0 ? (
                <div
                    ...
                    data-oid="aqynne6"
                >
                    <p className="text-gray-400" data-oid="7fjdf7g">
                ...
                <div
                    ...
                    data-oid="pp5ccd-"
                >
                    <div className="overflow-x-auto" data-oid="bbxhei7">
                        <table className="min-w-full divide-y divide-gray-700" data-oid="y.krdqc">
                            <thead className="bg-gray-900" data-oid="pseq-wu">
                                <tr data-oid="ig_5192">
                                    <th
                                        scope="col"
