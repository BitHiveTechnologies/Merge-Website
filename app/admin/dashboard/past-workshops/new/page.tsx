...
export default function NewPastWorkshopPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4" data-oid="a.60wwg">
            <div className="flex items-center justify-between mb-8" data-oid="5w2tyj_">
                <h1 className="text-3xl font-bold" data-oid="gz7:m2m">
            ...
            {error && (
                <div
                    ...
                    data-oid="seuqjxd"
                >
                    <p className="text-red-200" data-oid="cgic202">
                        {error}
                    </p>
                </div>
            )}
            ...
            <form
                ...
                data-oid="x.v_3lf"
            >
                <div className="grid grid-cols-1 gap-6" data-oid="87-obmt">
                    <div data-oid="0hc-ivd">
                        <label
                            htmlFor="institution"
                    ...
                    <div data-oid="505og6t">
                        <label className="block text-sm font-medium mb-2" data-oid="g6tnea5">
                            Highlights
                        </label>
                        {formData.highlights.map((highlight, index) => (
                            <div key={index} className="flex items-center mb-2" data-oid="dughlqf">
                                <input
                                    type="text"
                                    value={highlight}
                    ...
                    <div data-oid="y.ap61k">
                        <label className="block text-sm font-medium mb-2" data-oid="kgan7f-">
                            Media Links
                        </label>
                        {formData.mediaLinks.map((link, index) => (
                            <div key={index} className="flex items-center mb-2" data-oid="xj0tgud">
                                <input
                                    type="url"
                                    value={link}
                    ...
                    <div className="flex justify-end mt-4" data-oid="7d0wz9y">
                        <button
                            type="submit"
