...
export default function AdminLoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="2l9c9qb">
            <Navbar data-oid="2hyyd22" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="kxs5xwr">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden mt-12"
                    data-oid="f_07-ak"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="8v85ocb">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="_ir-mfj">
                        <div className="text-center mb-6" data-oid="wdqwi:7">
                            <h1 className="text-3xl font-bold mb-2" data-oid=".4fbw4t">
                                Admin Login
                            </h1>
                            <p className="text-gray-400" data-oid="knmv.66">
                        ...
                        <form onSubmit={handleSubmit} data-oid="12t4m9g">
                            <div className="mb-6" data-oid="x4b66md">
                                <label
                                    htmlFor="email"
                            ...
                            <div className="mb-6" data-oid="rp-0v-n">
                                <label
                                    htmlFor="password"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="-2ogppy"
                                ...
                                <div className="relative" data-oid="w56tz3r">
                                    <input
                                        id="password"
