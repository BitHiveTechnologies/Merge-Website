...
export default function AdminLoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="nbj2:yb">
            <Navbar data-oid="4z2468a" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="usvrza:">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden mt-12"
                    data-oid="vjtsl.z"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="w4j_z03">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="9ob3mvs">
                        <div className="text-center mb-6" data-oid="0l4d7.-">
                            <h1 className="text-3xl font-bold mb-2" data-oid="4w4us.r">
                                Admin Login
                            </h1>
                            <p className="text-gray-400" data-oid="w-wgfv9">
                        ...
                        <form onSubmit={handleSubmit} data-oid="5.629q.">
                            <div className="mb-6" data-oid=":gb6x-z">
                                <label
                                    htmlFor="email"
                            ...
                            <div className="mb-6" data-oid="g-y3zu5">
                                <label
                                    htmlFor="password"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="0vsg51e"
                                ...
                                <div className="relative" data-oid="_x7602i">
                                    <input
                                        id="password"
