...
export default function AdminLoginPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans" data-oid="yq8gr5_">
            <Navbar data-oid="em_2hgg" />

            <div className="pt-32 pb-20 px-6 md:px-12" data-oid="oc5u7zb">
                <div
                    className="max-w-md mx-auto bg-gray-800 rounded-xl border border-gray-700 overflow-hidden mt-12"
                    data-oid="_2lr2v3"
                >
                    {/* Background blur elements */}
                    <div className="relative" data-oid="2rd9njy">
                        <div
                    ...
                    {/* Content */}
                    <div className="relative p-6" data-oid="jaaovqm">
                        <div className="text-center mb-6" data-oid="49nn_z:">
                            <h1 className="text-3xl font-bold mb-2" data-oid="9ua:tvs">
                                Admin Login
                            </h1>
                            <p className="text-gray-400" data-oid="ijz07sj">
                        ...
                        <form onSubmit={handleSubmit} data-oid="364c606">
                            <div className="mb-6" data-oid="fimdahq">
                                <label
                                    htmlFor="email"
                            ...
                            <div className="mb-6" data-oid="iwd2.b.">
                                <label
                                    htmlFor="password"
                                    className="block text-sm font-medium mb-2"
                                    data-oid="m7f.:x8"
                                ...
                                <div className="relative" data-oid="3ajclp2">
                                    <input
                                        id="password"
