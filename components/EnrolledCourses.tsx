...
export default function EnrolledCourses() {
    ...
    return (
        <div className="py-8 px-6 md:px-12 bg-black" data-oid="y4aeffx">
            <div className="max-w-6xl mx-auto" data-oid="cyuaatm">
                <h2 className="text-2xl md:text-3xl font-bold mb-8" data-oid="othqrlo">
                    Your Enrolled Courses
                </h2>

                {isLoading ? (
                    <div className="flex justify-center items-center py-20" data-oid="tjv51r2">
                        <div
                    ...
                    <div className="text-center py-12" data-oid="5:3o6l:">
                        <p className="text-red-400 mb-4" data-oid="8-3s3sr">
                            {error}
                        </p>
                        <button
                    ...
                    <div
                        ...
                        data-oid="_t3oogy"
                    >
                        <h3 className="text-xl font-semibold text-gray-300 mb-4" data-oid="0mtb5xn">
                            You haven't enrolled in any courses yet
                        </h3>
                        <p className="text-gray-400 mb-6" data-oid="matky8k">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" data-oid="ejnfv_i">
                        {enrollments.map((enrollment) => (
                            <div
                                ...
                                data-oid="cfct11r"
                            >
                                <div className="relative h-48 overflow-hidden" data-oid="139up81">
                                    <img
                                ...
                                <div className="p-6" data-oid="lo7n3yx">
                                    <div
                                        className="flex justify-between items-start mb-2"
                                        data-oid="7ouxp33"
                                    >
                                        <h3 className="text-xl font-semibold" data-oid="oxc04hj">
                                    ...
                                    <div className="flex items-center mb-3" data-oid="o746zg9">
                                        <div
                                            className="w-8 h-8 rounded-full bg-gray-600 mr-3"
                                            data-oid="m:rtcj3"
                                        ></div>
                                        <span className="text-gray-300 text-sm" data-oid="z_5_.kl">
