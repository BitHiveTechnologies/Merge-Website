...
export default function EnrolledCourses() {
    ...
    return (
        <div className="py-8 px-6 md:px-12 bg-black" data-oid="puir-.:">
            <div className="max-w-6xl mx-auto" data-oid="0_6-bnq">
                <h2 className="text-2xl md:text-3xl font-bold mb-8" data-oid="s8md11b">
                    Your Enrolled Courses
                </h2>

                {isLoading ? (
                    <div className="flex justify-center items-center py-20" data-oid="aflcvdd">
                        <div
                    ...
                    <div className="text-center py-12" data-oid="n39na4e">
                        <p className="text-red-400 mb-4" data-oid="v-bctai">
                            {error}
                        </p>
                        <button
                    ...
                    <div
                        ...
                        data-oid="7-z9:0h"
                    >
                        <h3 className="text-xl font-semibold text-gray-300 mb-4" data-oid="xk8i5zw">
                            You haven't enrolled in any courses yet
                        </h3>
                        <p className="text-gray-400 mb-6" data-oid="dguqq2e">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" data-oid="4_u1s-8">
                        {enrollments.map((enrollment) => (
                            <div
                                ...
                                data-oid="nry3-km"
                            >
                                <div className="relative h-48 overflow-hidden" data-oid=".--5fr4">
                                    <img
                                ...
                                <div className="p-6" data-oid="j3gfw:k">
                                    <div
                                        className="flex justify-between items-start mb-2"
                                        data-oid="-fq5a1c"
                                    >
                                        <h3 className="text-xl font-semibold" data-oid="0l_rekw">
                                    ...
                                    <div className="flex items-center mb-3" data-oid="vgjvyxa">
                                        <div
                                            className="w-8 h-8 rounded-full bg-gray-600 mr-3"
                                            data-oid="04cg9he"
                                        ></div>
                                        <span className="text-gray-300 text-sm" data-oid=".q65731">
