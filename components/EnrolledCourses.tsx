...
export default function EnrolledCourses() {
    ...
    return (
        <div className="py-8 px-6 md:px-12 bg-black" data-oid="g_ddmfn">
            <div className="max-w-6xl mx-auto" data-oid="6mdjw73">
                <h2 className="text-2xl md:text-3xl font-bold mb-8" data-oid="f3vskxe">
                    Your Enrolled Courses
                </h2>

                {isLoading ? (
                    <div className="flex justify-center items-center py-20" data-oid="as872ey">
                        <div
                    ...
                    <div className="text-center py-12" data-oid="aapjlwm">
                        <p className="text-red-400 mb-4" data-oid="a1o2.wg">
                            {error}
                        </p>
                        <button
                    ...
                    <div
                        ...
                        data-oid="gzw9237"
                    >
                        <h3 className="text-xl font-semibold text-gray-300 mb-4" data-oid="lc:8071">
                            You haven't enrolled in any courses yet
                        </h3>
                        <p className="text-gray-400 mb-6" data-oid="ajakcia">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" data-oid="8ws2pi1">
                        {enrollments.map((enrollment) => (
                            <div
                                ...
                                data-oid="o:p5sdo"
                            >
                                <div className="relative h-48 overflow-hidden" data-oid="lrru:x3">
                                    <img
                                ...
                                <div className="p-6" data-oid="0pu-onl">
                                    <div
                                        className="flex justify-between items-start mb-2"
                                        data-oid="qye48q_"
                                    >
                                        <h3 className="text-xl font-semibold" data-oid="asqy-::">
                                    ...
                                    <div className="flex items-center mb-3" data-oid="5zabgv7">
                                        <div
                                            className="w-8 h-8 rounded-full bg-gray-600 mr-3"
                                            data-oid="wi5u9as"
                                        ></div>
                                        <span className="text-gray-300 text-sm" data-oid="z7j:56-">
