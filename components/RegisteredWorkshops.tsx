...
export default function RegisteredWorkshops() {
    ...
    return (
        <div className="py-8 px-6 md:px-12 bg-black" data-oid="sj6zs1o">
            <div className="max-w-6xl mx-auto" data-oid="fx18zez">
                <h2 className="text-2xl md:text-3xl font-bold mb-8" data-oid="zo.3hav">
                    Your Registered Workshops
                </h2>

                {isLoading ? (
                    <div className="flex justify-center items-center py-20" data-oid="u-7-1ba">
                        <div
                    ...
                    <div className="text-center py-12" data-oid="1uvzfrc">
                        <p className="text-red-400 mb-4" data-oid="l:vlfqd">
                            {error}
                        </p>
                        <button
                    ...
                    <div
                        ...
                        data-oid="ki29od0"
                    >
                        <h3 className="text-xl font-semibold text-gray-300 mb-4" data-oid="z8s9huk">
                            You haven't registered for any workshops yet
                        </h3>
                        <p className="text-gray-400 mb-6" data-oid="dh-e7rb">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" data-oid="16wbo6k">
                        {registrations.map((registration) => (
                            <div
                                ...
                                data-oid="bkr6_vm"
                            >
                                <div className="relative h-48 overflow-hidden" data-oid="cn2_enr">
                                    <img
                                ...
                                <div className="p-6" data-oid="ihaam6c">
                                    <h3 className="text-xl font-semibold mb-2" data-oid="0kf7wma">
                                    ...
                                    <div className="flex items-center mb-3" data-oid="-522a.3">
                                        <div
                                            className="w-8 h-8 rounded-full bg-gray-600 mr-3"
                                            data-oid="etdmlvs"
                                        ></div>
                                        <span className="text-gray-300 text-sm" data-oid="7g2k239">
                                    ...
                                    <div
                                        ...
                                        data-oid="bvagfb_"
                                    >
                                        <span data-oid="9l9q-0i">
                                            {formatDate(registration.workshopId.date)}
                                        </span>
                                        <span data-oid="-rzycnt">
                                    ...
                                    <div
                                        ...
                                        data-oid="x.v8o_:"
                                    >
                                        <span className="text-gray-300" data-oid="22::it.">
