...
export default function RegisteredWorkshops() {
    ...
    return (
        <div className="py-8 px-6 md:px-12 bg-black" data-oid="ao_1byt">
            <div className="max-w-6xl mx-auto" data-oid="oa1:ugi">
                <h2 className="text-2xl md:text-3xl font-bold mb-8" data-oid="ukl27j_">
                    Your Registered Workshops
                </h2>

                {isLoading ? (
                    <div className="flex justify-center items-center py-20" data-oid="obmjm29">
                        <div
                    ...
                    <div className="text-center py-12" data-oid="ddwqs-7">
                        <p className="text-red-400 mb-4" data-oid="qrwhpfh">
                            {error}
                        </p>
                        <button
                    ...
                    <div
                        ...
                        data-oid="nd:5ddk"
                    >
                        <h3 className="text-xl font-semibold text-gray-300 mb-4" data-oid="dq_gmw0">
                            You haven't registered for any workshops yet
                        </h3>
                        <p className="text-gray-400 mb-6" data-oid=":0l7wbn">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" data-oid="5x70qxv">
                        {registrations.map((registration) => (
                            <div
                                ...
                                data-oid="y9mmi9j"
                            >
                                <div className="relative h-48 overflow-hidden" data-oid="0ev9h2:">
                                    <img
                                ...
                                <div className="p-6" data-oid="ucsox63">
                                    <h3 className="text-xl font-semibold mb-2" data-oid="_edbffo">
                                    ...
                                    <div className="flex items-center mb-3" data-oid="j:d46kf">
                                        <div
                                            className="w-8 h-8 rounded-full bg-gray-600 mr-3"
                                            data-oid=".d.nnq7"
                                        ></div>
                                        <span className="text-gray-300 text-sm" data-oid="qtn4t_p">
                                    ...
                                    <div
                                        ...
                                        data-oid="4131x92"
                                    >
                                        <span data-oid="44r7pl:">
                                            {formatDate(registration.workshopId.date)}
                                        </span>
                                        <span data-oid="5:fkde-">
                                    ...
                                    <div
                                        ...
                                        data-oid="80pm9gs"
                                    >
                                        <span className="text-gray-300" data-oid="uw-u4_0">
