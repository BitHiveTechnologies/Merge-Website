...
export default function RegisteredWorkshops() {
    ...
    return (
        <div className="py-8 px-6 md:px-12 bg-black" data-oid="0nedoz.">
            <div className="max-w-6xl mx-auto" data-oid="28o5e:n">
                <h2 className="text-2xl md:text-3xl font-bold mb-8" data-oid="53h:n:f">
                    Your Registered Workshops
                </h2>

                {isLoading ? (
                    <div className="flex justify-center items-center py-20" data-oid="givu.rs">
                        <div
                    ...
                    <div className="text-center py-12" data-oid="w3nl9l6">
                        <p className="text-red-400 mb-4" data-oid="7z-zg6p">
                            {error}
                        </p>
                        <button
                    ...
                    <div
                        ...
                        data-oid="pt:wuwt"
                    >
                        <h3 className="text-xl font-semibold text-gray-300 mb-4" data-oid="k8evj29">
                            You haven't registered for any workshops yet
                        </h3>
                        <p className="text-gray-400 mb-6" data-oid="g1.sxhk">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" data-oid="606h2yn">
                        {registrations.map((registration) => (
                            <div
                                ...
                                data-oid="1c6equt"
                            >
                                <div className="relative h-48 overflow-hidden" data-oid="tyz.2n4">
                                    <img
                                ...
                                <div className="p-6" data-oid="5y:s7n8">
                                    <h3 className="text-xl font-semibold mb-2" data-oid="wtbsby:">
                                    ...
                                    <div className="flex items-center mb-3" data-oid="em0h1qe">
                                        <div
                                            className="w-8 h-8 rounded-full bg-gray-600 mr-3"
                                            data-oid="69dl5t8"
                                        ></div>
                                        <span className="text-gray-300 text-sm" data-oid="mwx6ien">
                                    ...
                                    <div
                                        ...
                                        data-oid="xig0ho."
                                    >
                                        <span data-oid="j1nlv87">
                                            {formatDate(registration.workshopId.date)}
                                        </span>
                                        <span data-oid="48vm.pl">
                                    ...
                                    <div
                                        ...
                                        data-oid="s4f-zf9"
                                    >
                                        <span className="text-gray-300" data-oid="pre7.j5">
